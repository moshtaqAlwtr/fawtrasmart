...
class LeaveTypesController extends Controller
{
    public function index()
    {
        ...
        return view('attendance.settings.leave_types.index',compact('leave_types'));
    }
    public function create()
    {
        return view('attendance.settings.leave_types.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('attendance.settings.leave_types.edit',compact('leaveType'));
    }
    ...
    {
        $leaveType = LeaveType::findOrFail($id);
        return view('attendance.settings.leave_types.show',compact('leaveType'));
    }
