...
class AncestorController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('salaries.ancestor.index', compact('ancestors', 'paymentRates', 'statuses', 'branches', 'tags', 'employees', 'account_setting', 'displayedTotalAmount', 'displayedTotalPaid', 'displayedTotalInstallments', 'displayedProgressPercentage', 'request'));
    }
    ...
    public function show($id)
    {
        try {
            ...
            return view('salaries.ancestor.show', compact('ancestor', 'id', 'totalPaid', 'paidInstallments', 'progressPercentage', 'account_setting'));
        } catch (\Exception $e) {
