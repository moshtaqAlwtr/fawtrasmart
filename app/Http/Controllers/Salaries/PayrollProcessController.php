...
class PayrollProcessController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('salaries.payroll_ process.index', compact('payrolls', 'departments', 'branches', 'jobTitles', 'employees'));
    }
    public function create()
    {
        ...
        $employees = Employee::select('id', 'first_name', 'middle_name')->get();
        return view('salaries.payroll_ process.create', compact('employees', 'payrolls', 'branches', 'departments', 'jop_titles'));
    }
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'department_id' => 'nullable|required_if:selection,2',
            'jop_title_id' => 'nullable|required_if:selection,2',
            'branch_id' => 'nullable|required_if:selection,2',
