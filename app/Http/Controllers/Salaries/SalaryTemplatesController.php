...
class SalaryTemplatesController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('salaries.salary_templates.index', compact('SalaryTemplates', 'types'));
    }
    ...
    public function create()
    {
        ...
        return view('salaries.salary_templates.create', compact('additionItems', 'deductionItems'));
    }
    public function show($id)
    {
        ...
        $deductionItems = SalaryItem::where('type', 2)->select('id', 'name', 'calculation_formula', 'amount')->get();
        return view('salaries.salary_templates.show', compact('salaryTemplates', 'addition', 'deductionItems'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('salaries.salary_templates.edit', compact('salaryTemplates', 'additionItems', 'deductionItems'));
    }
