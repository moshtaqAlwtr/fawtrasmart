...
class ContractsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('salaries.contracts.index', compact('contracts', 'employees', 'jobTitles', 'salaryTemplates', 'departments', 'salaryItems', 'users', 'branches'));
    }
    public function create()
    {
        ...
        return view('salaries.contracts.create', [
            'employees' => Employee::all(),
            'jopTitle' => JopTitle::all(),
            'functionalLevels' => FunctionalLevels::all(),
            'salaryTemplates' => SalaryTemplate::all(),
            'additionItems' => SalaryItem::where('type', 'addition')->get(),
            'deductionItems' => SalaryItem::where('type', 'deduction')->get(),
    ...
    public function store(Request $request)
    {
        try {
            ...
            $request->validate([
                ...
                'job_level_id' => 'required|exists:functional_levels,id',
                'salary_temp_id' => 'required|exists:salary_template,id',
 ...
 'description' => 'تم انشاء قصد  ',
    ...
    public function show($id)
    {
        ...
        return view('salaries.contracts.show', compact('contract', 'additionItems', 'deductionItems'));
    }
    public function edit($id)
    {
        ...
        return view('salaries.contracts.edit', compact('contract', 'employees', 'jopTitle', 'functionalLevels', 'salaryTemplates', 'additionItems', 'deductionItems'));
    }
    ...
    public function printContract1($id)
    {
        try {
            ...
            // عرض صفحة الطباعة
            return view('salaries.contracts.contract_print.contract_prin1',
