...
class SeasonalPricesController extends Controller

    {
        public function index()
        {
            ...
            return view('rental_management.seasonal-prices.index', compact('prices')); // تمرير البيانات إلى العرض
        }
  // في الـController
public function create()
{
    ...
    return view('rental_management.seasonal-prices.create', compact('unitTypes', 'pricingRules'));
}
public function show($id)
{
    $seasonalPrice = SeasonalPrice::findOrFail($id); // جلب البيانات من قاعدة البيانات بناءً على المعرف
    return view('rental_management.seasonal-prices.show', compact('seasonalPrice'));
}
    ...
    public function edit($id)
{
    ...
    return view('rental_management.seasonal-prices.edit', compact('seasonalPrice', 'unitTypes', 'pricingRules'));
}
