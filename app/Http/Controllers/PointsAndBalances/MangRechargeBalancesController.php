    ...
    public function show($id)
{
    ...
    // Return the view with the fetched data
    return view('pointsAndBalances.mangRechargeBalances.show', compact('balanceCharge'));
}
    public function edit($id)
    {
        ...
        $balanceTypes = BalanceType::all();
        return view('pointsAndBalances.mangRechargeBalances.edit', compact('clients', 'balanceCharge', 'balanceTypes'));
    }
