...
class BalanceTypeController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pointsAndBalances.sitting.balanceType.index', compact('balanceTypes'));
    }
    public function create()
    {
        $balanceTypes = BalanceType::all();
        return view('pointsAndBalances.sitting.balanceType.create', compact('balanceTypes'));
    }
...
public function show($id)
{
    ...
    return view('pointsAndBalances.sitting.balanceType.show', compact('balanceType'));
}
    public function edit($id)
    {
        $balanceType = BalanceType::findOrFail($id);
        return view('pointsAndBalances.sitting.balanceType.edit',compact('balanceType'));
    }
