    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if ($journalEntry) {
                ...
                $treasuryDetail = JournalEntryDetail::where('journal_entry_id', $journalEntry->id)->where('account_id', $MainTreasury->id)->first();
                ...
                $incomeDetail = JournalEntryDetail::where('journal_entry_id', $journalEntry->id)->where('account_id', $oldAccountId)->first();
