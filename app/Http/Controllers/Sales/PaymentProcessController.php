...
class PaymentProcessController extends Controller
{
    public function index(Request $request)
    {
        ...
        $payments = $query = PaymentsProcess::orderBy('created_at', 'DESC')->paginate(25);
    ...
    public function getInvoiceDetails($invoice_id)
    {
        try {
            ...
            $totalPayments = PaymentsProcess::where('invoice_id', $invoice->id)->where('type', 'client payments')->sum('amount');
