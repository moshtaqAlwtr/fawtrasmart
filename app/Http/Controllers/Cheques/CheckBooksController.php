...
class CheckBooksController extends Controller
{
    public function index()
    {
        ...
        return view('cheques.check_books.index', compact('check_books'));
    }

    public function create()
    {
        $bank_accounts = Treasury::where('type', 1)->select('id', 'bank_name')->get();
        return view('cheques.check_books.create', compact('bank_accounts'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('cheques.check_books.edit', compact('checkbook', 'bank_accounts'));
    }
