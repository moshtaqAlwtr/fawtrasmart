<?php
use App\Http\Controllers\Rental_Management\GeneralController;
use App\Http\Controllers\Rental_Management\ReservationStatusController;
use App\Http\Controllers\Rental_Management\SeasonalPricesController;
use App\Http\Controllers\Rental_Management\SettingsController;
use App\Http\Controllers\Rental_Management\UnitsController;
use App\Http\Controllers\Rental_Management\RentalPriceRuleController;
use App\Http\Controllers\Rental_Management\OrdersController;
use App\Http\Controllers\Rental_Management\AddTypeController;
use App\Http\Controllers\Rental_Management\ProductsController;
...
Route::get('/api/unit-types/{unitTypeId}/pricing', [RentalPriceRuleController::class, 'getPricingByUnitType']);
