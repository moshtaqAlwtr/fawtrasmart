                            ...
                            <div class="form-body row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" name="from_store_houses_id" id="from_store_houses_id">
                                        @foreach ($storeHouses as $storeHouse)
                                            <option value="{{ $storeHouse->id }}" {{ old('store_houses_id',$permit->from_store_houses_id) == $storeHouse->id ? 'selected' : '' }}>{{ $storeHouse->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" name="to_store_houses_id" id="to_store_houses_id">
                                        @foreach ($storeHouses as $storeHouse)
                                            <option value="{{ $storeHouse->id }}" {{ old('store_houses_id',$permit->to_store_houses_id) == $storeHouse->id ? 'selected' : '' }}>{{ $storeHouse->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="basicSelect" name="sub_account">
                                        <option value="1" {{ old('sub_account',$permit->sub_account) == 0 ? 'selected' : '' }}>الحساب الفرعي 1</option>
                                        <option value="2" {{ old('sub_account',$permit->sub_account) == 1 ? 'selected' : '' }}>الحساب الفرعي 2</option>
                                    </select>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>رقم <span style="color: red">*</span></label>
                                    <input type="number" class="form-control" name="number" value="{{ old('number',$permit->number) }}">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="feedback2">الملاحظات </label>
                                    <textarea class="form-control" rows="2" placeholder="ادخل ملاحظاتك هنا" name="details">{{ old('details',$permit->details) }}</textarea>
                                </div>
