                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="leave-type" name="leave_type">
                            ...
                            <option value="1" {{ old('leave_type') == '1' ? 'selected' : '' }}>الوصول المتأخر</option>
                            <option value="2" {{ old('leave_type') == '2' ? 'selected' : '' }}>الانصراف المبكر</option>
                        </select>
                        @error('leave_type')
                        <small class="text-danger" id="basic-default-name-error" class="error"></small>
                            {{ $message }}
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="type" name="type">
                            ...
                            <option value="1" {{ old('type') == '1' ? 'selected' : '' }}> إجازة اعتيادية</option>
                            <option value="2" {{ old('type') == '2' ? 'selected' : '' }}>إجازة عرضية</option>
                        </select>
                        @error('type')
                        <small class="text-danger" id="basic-default-name-error" class="error"></small>
                            {{ $message }}
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="application-date" name="submission_date" value="{{ old('submission_date') }}">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="notes" rows="3" placeholder="أدخل ملاحظاتك" name="notes">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </form>
        </div>
