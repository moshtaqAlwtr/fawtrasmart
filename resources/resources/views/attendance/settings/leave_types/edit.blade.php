...
@section('content')
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div>
                    ...
                    <button type="submit" form="editLeaveTypeForm" class="btn btn-outline-primary">
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="mb-4">معلومات نوع الإجازة</h4>
            <form id="editLeaveTypeForm" method="POST" action="{{ route('leave_types.update', $leaveType->id) }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" class="form-control" id="application-date" name="name" value="{{ old('name', $leaveType->name) }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="number" class="form-control" name="max_days_per_year" value="{{ old('max_days_per_year', $leaveType->max_days_per_year) }}">
                    </div>


                    <div class="col-md-6 mb-2">
                        <label for="employee" class="form-label">الحد الأقصى للأيام المتوالية القابلة للتطبيق</label>
                        <input type="number" class="form-control" name="max_consecutive_days" value="{{ old('max_consecutive_days', $leaveType->max_consecutive_days) }}">
                    </div>


                    <div class="col-md-6 mb-2">
                        <label for="employee" class="form-label">قابلة للتطبيق بعد</label>
                        <input type="number" class="form-control" name="applicable_after" value="{{ old('applicable_after', $leaveType->applicable_after) }}">
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="vs-checkbox-con vs-checkbox-primary">
                            <label for=""></label>
                            <input type="checkbox" name="requires_approval" value="true" {{ old('requires_approval', $leaveType->requires_approval == 1) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="vs-checkbox-con vs-checkbox-primary">
                            <label for=""></label>
                            <input type="checkbox" name="replace_weekends" value="true" {{ old('replace_weekends', $leaveType->replace_weekends == 1) ? 'checked' : '' }}>
                            <span class="vs-checkbox">
                                <span class="vs-checkbox--check">
                                    <i class="vs-icon feather icon-check"></i>
                                </span>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="description" rows="2" placeholder="أدخل الوصف" name="description">{{ old('description', $leaveType->description) }}</textarea>
                    </div>
