            ...
            <form id="AttendanceDeterminantForm" method="POST" action="{{ route('attendance_determinants.update', $attendance_determinants->id) }}">
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="application-date" name="name" value="{{ old('name', $attendance_determinants->name) }}">
                    </div>
                    ...
                    <div class="col-md-6 mt-1">
                        <fieldset>
                            <div class="vs-checkbox-con vs-checkbox-primary">
                                <input type="checkbox" value="1" name="capture_employee_image" {{ old('capture_employee_image', $attendance_determinants->capture_employee_image) == 1 ? 'checked' : '' }}>
                ...
                <div class="row mb-2">
                    <div class="col-md-6 mt-1">
                        <fieldset>
                            <div class="vs-checkbox-con vs-checkbox-primary">
                                <input type="checkbox" value="1" name="enable_ip_verification" {{ old('enable_ip_verification', $attendance_determinants->enable_ip_verification) == 1 ? 'checked' : '' }}>
                                <span class="vs-checkbox">
                                    <span class="vs-checkbox--check">
                                        <i class="vs-icon feather icon-check"></i>
                                    </span>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="allowed_ips" class="form-control" rows="2">{{ old('allowed_ips','2a02:cb80:4226:39aa:a4b2:a9c2:913d:a3de', $attendance_determinants->allowed_ips) }}</textarea>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    <div class="col-md-6 mt-1">
                        <fieldset>
                            <div class="vs-checkbox-con vs-checkbox-primary">
                                <input type="checkbox" value="1" name="enable_location_verification" {{ old('enable_location_verification', $attendance_determinants->enable_location_verification) == 1 ? 'checked' : '' }}>
                                <span class="vs-checkbox">
                                    <span class="vs-checkbox--check">
                                        <i class="vs-icon feather icon-check"></i>
                                    </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" min="1" step="0.01"  name="radius" value="{{ old('radius', $attendance_determinants->radius) }}">
                    </div>

                    <div class="col-md-6">
                        <label for="">المقياس <span class="text-danger">*</span></label>
                        <select name="radius_type" class="form-control">
                            <option value="1" {{ old('radius_type', $attendance_determinants->radius_type) == 1 ? 'selected' : '' }}>أمتار</option>
                            <option value="2" {{ old('radius_type', $attendance_determinants->radius_type) == 2 ? 'selected' : '' }}>كيلومترات</option>
                        </select>
                    </div>
