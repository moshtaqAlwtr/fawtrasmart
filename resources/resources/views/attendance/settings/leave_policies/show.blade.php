...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{ $leave_policy->name }}</h2>
    ...
    <div class="card">
        <div class="card-title p-2">
            <a href="#" class="btn btn-outline-danger btn-sm waves-effect waves-light" data-toggle="modal" data-target="#modal_DELETE{{ $leave_policy->id }}">حذف <i class="fa fa-trash"></i></a>
            <a href="{{ route('leave_policy.edit',$leave_policy->id) }}" class="btn btn-outline-primary btn-sm waves-effect waves-light">تعديل <i class="fa fa-edit"></i></a>
            <a href="{{ route('leave_policy.leave_policy_employees',$leave_policy->id) }}" class="btn btn-outline-success btn-sm">قم بالتخصيص للموظفين <i class="fa fa-users"></i></a>
            <a href="{{ route('leave_policy.updateStatus',$leave_policy->id) }}" class="btn btn-outline-{{ $leave_policy->status == 0 ? 'danger' : 'success' }} btn-sm waves-effect waves-light">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="details-tab" data-toggle="tab" href="#details" role="tab"
                        aria-controls="details" aria-selected="true">التفاصيل</a>
                </li>
                                ...
                                <div class="row">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <p><small>الوصف </small>: </p><span>{{ $leave_policy->description }}</span></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
