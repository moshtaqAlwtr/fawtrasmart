...
@section('content')
        ...
        <div class="content-header-left col-md-9 col-12 d-flex align-items-center">
            <div class="row breadcrumbs-top flex-grow-1">
                <div class="col-12 d-flex align-items-center">
                    <h2 class="content-header-title mb-0 me-3">تقارير مدفوعات الموردين </h2>
    ...
    <div class="card">
        <div class="card-header">مدفوعات الموردين</div>
        <div class="card-body">
            <form id="inventoryForm" method="GET" action="{{ route('ReportsPurchases.paymentPurchases') }}">
                <div class="row mb-3">
                    <!-- فلترة حسب المورد -->
                    <div class="col-md-4">
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="{{ route('ReportsPurchases.paymentPurchases') }}" class="btn btn-secondary" id="resetFilter">إلغاء الفلترة</a>
    ...
    <div class="chart-container card">
        <div class="card-body">
            <h5 class="card-title">مخطط فواتير الشراء</h5>
            <canvas id="purchaseChart" width="300" height="300"></canvas>
        </div>
    </div>
                ...
                <tbody>
                    @foreach ($groupedInvoices as $supplierId => $invoices)
                        ...
                        @foreach ($invoices as $invoice)
                            @php
                                $totalPaid = $invoice->payments_process->sum('amount');
