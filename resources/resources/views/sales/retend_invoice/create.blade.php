                                ...
                                <tbody>
                                    @foreach ($invoice->items as $index => $item)
                                        <tr class="item-row">
                                            ...
                                            <td>
                                                <input type="number" name="items[{{ $index }}][tax_1]" class="form-control tax" value="{{ $item->tax_1 }}" min="0" max="100" step="0.01">
                                            </td>
                                            <td>
                                                <input type="number" name="items[{{ $index }}][tax_2]" class="form-control tax" value="{{ $item->tax_2 }}" min="0" max="100" step="0.01">
                                            </td>
                                            <td>
