...
@section('content')
    ...
    <div class="content-body">
        <form id="invoice-form" action="{{ route('ReturnsInvoice.update', $purchaseRentalInvoice->id) }}" method="post">
            @csrf
            @method('PUT')
            @if ($errors->any())
                            ...
                            <table class="table" id="items-table">
                                ...
                                <tbody>
                                    <tr class="item-row">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="number" name="items[0][discount_value]" class="form-control discount-value" value="0"
                                        min="0" step="0.01">
