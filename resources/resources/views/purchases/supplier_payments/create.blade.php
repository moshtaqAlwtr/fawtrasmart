...
@section('content')
    ...
    <form action="{{ route('PaymentSupplier.storePurchase') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number"
                               ...
                               placeholder="المبلغ"
                               step="0.01"
                               value="{{ $purchase->grand_total ?? 0 }}"
                               data-total="{{ $purchase->grand_total ?? 0 }}"
                               required>
                        <div class="remaining-amount mt-1 text-muted small">
                            المبلغ المتبقي: <span id="remainingAmount">{{ $purchase->grand_total ?? 0 }}</span> ر.س
                        </div>
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select name="status_payment" class="form-control" id="status_payment" required>
                            ...
                            <option value="4">فاشلة</option>
                            <option value="5">مسودة</option>
                        </select>
                    </div>
                    <div class="col-md-6">
