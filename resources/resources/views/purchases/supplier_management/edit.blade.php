...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">تعديل مورد </h2>
    ...
    <div class="content-body">
        <form id="clientForm" action="{{ route('SupplierManagement.update', $supplier->id) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" name="trade_name" id="trade_name"
                                                        class="form-control" value="{{ old('trade_name', $supplier->trade_name) }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" name="first_name" id="first_name"
                                                        class="form-control" value="{{ old('first_name', $supplier->first_name) }}">
                                                    <div class="form-control-position">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" name="last_name" id="last_name"
                                                        class="form-control" value="{{ old('last_name', $supplier->last_name) }}">
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" name="street2" id="street2"
                                                        class="form-control" value="{{ old('street2', $supplier->street2) }}">
                                                    <div class="form-control-position">
                                                        <i class="feather icon-map-pin"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" name="city" id="city"
                                                        class="form-control" value="{{ old('city', $supplier->city) }}">
                                                    <div class="form-control-position">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" name="region" id="region"
                                                        class="form-control" value="{{ old('region', $supplier->region) }}">
                                                    <div class="form-control-position">
                                                        <i class="feather icon-map"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" name="postal_code" id="postal_code"
                                                        class="form-control" value="{{ old('postal_code', $supplier->postal_code) }}">
                                                    <div class="form-control-position">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" name="tax_number" id="tax_number"
                                                        class="form-control" value="{{ old('tax_number', $supplier->tax_number) }}">
                                                    <div class="form-control-position">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="number_suply" class="form-control"
                                                        name="number_suply" value="{{old('number_suply') ?? $nextNumber }}" readonly
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="number" id="opening_balance" class="form-control"
                                                        name="opening_balance" value="{{ old('opening_balance', $supplier->opening_balance) }}">
                                                    <div class="form-control-position">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control" id="notes" name="notes" rows="5" style="resize: none;">{{ old('notes', $supplier->notes) }}</textarea>
                                        </div>
