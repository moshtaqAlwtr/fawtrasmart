    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0"> تعديل  امر شراء </h2>
                    ...
                    <div id="section-discount" class="tab-section">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="number" name="discount_amount" class="form-control discount-amount"
                                    value="0" min="0" step="0.01">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">نوع الخصم</label>
                                <select class="form-control discount-type" name="discount_percentage">
                                    <option value="amount">ريال</option>
