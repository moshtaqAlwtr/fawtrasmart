...
@section('content')
    ...
    <div class="content-body">
        <div class="content-body">
            <form class="form" action="{{ route('Quotations.update', $purchaseQuotation->id) }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="form-body row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="feedback1" class="form-control" placeholder="الكود" name="code"
                                    value="{{ str_pad((\App\Models\PurchaseQuotation::max('id') ?? 0) + 1, 5, '0', STR_PAD_LEFT) }}">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="feedback1" class=""> تاريخ الطلب </label>
                                <input type="date" id="feedback1" class="form-control" name="order_date"
                                    value="{{ old('order_date', $purchaseQuotation->order_date) }}">
                        ...
                        <div class="form-body row">
                            <div class="form-group col-md-12">
                                <label for="supplier_id" class=""> اختر الموردين <span
                                        style="color: red">*</span></label>
                                <select id="supplier_id" class="form-control select2" name="supplier_id[]"
                                    multiple="multiple" value="{{ old('supplier_id', $purchaseQuotation->supplier_id) }}">
                                ...
                                <tr class="product-row">
                                    ...
                                    <td>
                                        <div class="position-relative">
                                            <select class="form-control item-select" name="product_details[0][product_id]">
                                    ...
                                    <td>
                                        <input type="number" class="form-control amount-input" placeholder="ادخل كمية"
                                            name="product_details[0][quantity]"
                                            value=""
                                            min="1">
                                    </td>
                                    <td class="align-middle text-center">
    ...
    @section('scripts')
        <script>
            ...
            function addNewRow() {
                ...
                <td>
                    <div class="position-relative">
                        <select class="form-control item-select" name="product_details[${rowCounter}][product_id]" >
                            <option value="">اختر البند</option>
                            @foreach ($products as $product)
                                <option value="{{ $product->id }}">{{ $product->name }}</option>
                            @endforeach
                ...
                <td>
                    <input type="number" class="form-control amount-input" placeholder="ادخل كمية"
                        name="product_details[${rowCounter}][quantity]" min="1" >
                </td>
                <td class="align-middle text-center">
