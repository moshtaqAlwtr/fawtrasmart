...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0"> تعديل عرض سعر مشتريات</h2>
    ...
    <div class="content-body">
        <form id="invoice-form" action="{{ route('pricesPurchase.update', $purchaseQuotation->id) }}" method="post">
            @csrf
            @if ($errors->any())
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control select2" value="{{ old('supplier_id', $purchaseQuotation->supplier_id) }}" id="clientSelect" name="supplier_id"
                                                    required>
                                ...
                                <div class="row add_item">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="date" name="date" value="{{ old('date', $purchaseQuotation->date) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" type="text" name="valid_days" value="{{ old('valid_days', $purchaseQuotation->valid_days) }}">
                                            </div>
                                            <div class="col-md-2">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <select name="account_id" id="" class="form-control" value="{{ old('account_id', $purchaseQuotation->account_id) }}">
