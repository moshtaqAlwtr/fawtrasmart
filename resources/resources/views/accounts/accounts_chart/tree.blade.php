...
<head>
    ...
    <style>
        ...
        table td {
            padding: 12px;
            /* زيادة التباعد داخل الخلايا */
            text-align: right;
            /* محاذاة النص لليمين */
            border-bottom: 1px solid #ddd;
            /* إضافة حدود بين الصفوف */
        }
...
<body
                            ...
                            <div class="d-flex align-items-center">
                                <fieldset class="form-group position-relative has-icon-left mx-1 my-0 w-50">
                                    <form action="{{ route('accounts.index') }}" method="GET">
                                        <input type="text" name="search" class="form-control" placeholder="بحث" value="{{ $searchText ?? '' }}">
    ...
    // إرسال النموذج تلقائيًا عند تغيير الفرع
