...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">المدفوعات حسب طريقة الدفع </h2>
        ...
        <div class="card-body">
            ...
            <form>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label for="status">تم التحصيل بواسطة:</label>
                        <select class="form-control" id="status">
                            <option>الكل</option>
                            <option>محمد المنصوب</option>
                            <option>محمد الأدريسي</option>
                            <option> عدنان العولقي</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <label for="order">وسيلة دفع :</label>
            ...
            <div class="row">
                ...
                <div class="col-6 text-right">
                    <div class="report-title">
                        تقرير المدفوعات حسب طريقة الدفع للفواتير
                    </div>
                    <!-- المدة الزمنية -->
