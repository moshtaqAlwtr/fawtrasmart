...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">المصروفات الأسبوعية</h2>
...
<div class="card mt-5">
    <div class="card">
        <div class="card-header bg-primary text-white text-center">
            <h5 class="mb-0">المصروفات - تجميع أسبوعيا</h5>
        </div>
        <div class="card-body">
            <div class="text-center mb-3">
                <p class="mb-1">الوقت: 19/12/2024 01:22</p>
                <p class="mb-1">التاريخ من: 19/11/2024 | التاريخ إلى: 25/12/2024 |</p>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="12" class="bg-light text-start fw-bold">20/11/2024 الأسبوع من</td>
                        </tr>
                        <tr>
                            <td>0</td>
                            <td>0</td>
                        ...
                        <tr>
                            <td colspan="12" class="bg-light text-start fw-bold">21/11/2024 الأسبوع من</td>
                        </tr>
                        <tr>
                            <td>0</td>
                            <td>0</td>
