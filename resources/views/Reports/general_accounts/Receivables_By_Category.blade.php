...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">سندات القبض حسب التصنيف</h2>
...
<div class="card mt-5">
    <div class="card">
        <div class="card-header bg-primary text-white text-center">
            <h5 class="mb-0">سندات القبض - تجميع حسب التصنيف</h5>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                        ...
                        <tr class="table-primary">
                            <td colspan="10" class="text-start fw-bold">محروقات</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>3</td>
