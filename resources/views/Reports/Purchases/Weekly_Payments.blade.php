...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">تقرير المدفوعات الأسبوعية</h2>
...
<div class="container mt-4">
    ...
    <div class="card shadow">
        <div class="card-body">
            <h5 class="card-title">بيانات المدفوعات الأسبوعية</h5>

            <!-- تاريخ اليوم -->
            <h6>التاريخ:من 14/09/2024 إلى 14/12/2024</h6>
