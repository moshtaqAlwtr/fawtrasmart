                                ...
                                <div class="activity-item">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="mb-0 ml-2">أنشأ محمد الإدريسي عرض الأسعار رقم <strong>#00002</strong>
                                                للعميل <strong>تونيبات سدرة ماركه للعروض</strong> بإجمالي
                                                <strong>270.00</strong> (عرض <strong>#309</strong>)</p>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <span class="mr-2">18:11:38 - محمد الإدريسي</span>
                                            <span class="badge badge-pill badge-info">Main Branch</span>
                                            <button class="btn btn-outline-success btn-sm ml-2"><i
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="5" class="text-right font-weight-bold">الإجمالي: -16.25
                                                    ر.س</td>
                                            </tr>
                                        </tbody>
                                    </table>
