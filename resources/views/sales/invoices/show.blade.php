        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div class="d-flex gap-2">
                        <!-- تعديل -->
                        <a href="{{ route('invoices.edit', $invoice->id) }}" class="btn btn-sm btn-outline-danger d-inline-flex align-items-center">
                        ...
                        <!-- PDF -->
                        <a href="{{ route('invoices.generatePdf', $invoice->id) }}" class="btn btn-sm btn-outline-info d-inline-flex align-items-center">
                            <i class="fas fa-file-pdf me-1"></i> PDF
                        </a>

                        <!-- إضافة عملية دفع -->
                        <a href="{{ route('paymentsClient.create', ['id' => $invoice->id, 'type' => 'invoice']) }}" class="btn btn-sm btn-outline-dark d-inline-flex align-items-center">
                        ...
                        <div class="dropdown">
                            <button
                                class="btn btn-sm btn-outline-warning d-inline-flex align-items-center dropdown-toggle"
                                type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fas fa-ticket-alt me-1"></i> قسائم
                            </button>
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">

                                <li><a class="dropdown-item" href="#"><i class="fas fa-tag me-1"></i> ملصق
                                        الطرد</a></li>
                                <li><a class="dropdown-item" href="#"><i class="fas fa-list me-1"></i> قائمة
                                        الإسلام</a></li>
                                <li><a class="dropdown-item" href="#"><i class="fas fa-truck me-1"></i> ملصق
                                        الشحن</a></li>
                                <li><a class="dropdown-item" href="#"><i class="fas fa-file-invoice me-1"></i>
                                        فاتورة حرارية</a></li>
                            </ul>
                        </div>
                        ...
                        <!-- اشعار دائن -->
                        <a href="{{ route('CreditNotes.create', ['id' => $invoice->id]) }}" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center">
                    ...
                    <div class="tab-pane fade" id="payments" role="tabpanel" aria-labelledby="payments-tab">
                        <div class="invoice-payments content-area invoice-Block">
                            <h3>
                                ...
                                <a href="{{ route('paymentsClient.create', ['id' => $invoice->id, 'type' => 'invoice']) }}" class="btn btn-success pull-right add-payment">
                                    {{ __('إضافة عملية دفع') }}
                                </a>
                            </h3>
