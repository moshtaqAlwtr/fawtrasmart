                    ...
                    <div class="card-body">
                        <form class="form">
                            ...
                            <div class="form-body row">
                                <!-- Row 1 -->
                                <div class="form-group col-md-6">
                                    <label for="feedback2" class="" style="font-size: 1.2rem;"> الفترات </label>
                                    <select id="feedback2" class="form-control" style="font-size: 1.2rem;">
                                        <option value="" style="font-size: 1.2rem;"> كل الفترات </option>
                                        <option value="" style="font-size: 1.2rem;"> سنويا </option>
                                        <option value="" style="font-size: 1.2rem;"> شهريا </option>
                                        <option value="" style="font-size: 1.2rem;"> اسبوعي </option>
                                        <option value="" style="font-size: 1.2rem;"> يومي </option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="feedback2" class="" style="font-size: 1.2rem;"> النوع </label>
                                    <select id="feedback2" class="form-control" style="font-size: 1.2rem;">
                                        <option value="" style="font-size: 1.2rem;"> كل الانواع  </option>
                                        <option value="" style="font-size: 1.2rem;">  العضوية </option>
                                        <option value="" style="font-size: 1.2rem;"> شحن الرصيد </option>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table" style="font-size: 1.2rem;">
                        ...
                        <tbody>
                            <tr>
                                <td style="font-size: 1.2rem;">مجاني #1</td>
                                <td style="font-size: 1.2rem;">العضوية</td>
                                <td style="font-size: 1.2rem;">100</td>
                                <td style="font-size: 1.2rem;">10 شهر</td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton303">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('PackageManagement.show', 1) }}" style="font-size: 1.2rem;">
                                                    <i class="fa fa-eye me-2 text-primary"></i>عرض
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="{{ route('PackageManagement.edit', 1) }}" style="font-size: 1.2rem;">
                                                    <i class="fa fa-edit me-2 text-success"></i>تعديل
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item text-danger" href="#" data-toggle="modal" style="font-size: 1.2rem;"
