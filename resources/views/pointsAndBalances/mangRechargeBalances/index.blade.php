                    ...
                    <table class="table" style="font-size: 1.1rem;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>-</td>
                                <td>1<br><small class="text-muted">نقطة</small></td>
                                <td>
                                    <div class="text-muted">0 مستهلك</div>
                                    <div class="border-top mt-1 pt-1">1 متبقي</div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="btn-group">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton303">
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('MangRechargeBalances.show', 1) }}">
                                                        <i class="fa fa-eye me-2 text-primary"></i>عرض
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('MangRechargeBalances.edit', 1) }}">
