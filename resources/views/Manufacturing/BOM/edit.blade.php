...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">تعديل قائمة مواد الإنتاج</h2>
    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <form class="form-horizontal" action="{{ route('Bom.update', $productionMaterial->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <h4 class="card-title">تعديل قائمة مواد الإنتاج</h4>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ $productionMaterial->name }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="">كود <span style="color: red">*</span></label>
                                    <input type="text" class="form-control" name="code" value="{{ $productionMaterial->code }}">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="quantity" value="{{ $productionMaterial->quantity }}">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <p onclick="toggleSection('rawMaterials')" class="d-flex justify-content-between section-header" style="background: #DBDEE2; width: 100%;">
                                        <span class="p-1 font-weight-bold"><i class="feather icon-package"></i> المواد الخام (<span id="rawMaterialCount">{{ count($productionMaterialItems) }}</span>)</span>
                                    ...
                                    <div id="rawMaterials">
                                        <table class="table table-striped" id="itemsTable">
                                            ...
                                            <tbody>
                                                @foreach ($productionMaterialItems as $item)
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <select name="raw_production_stage_id[]" class="form-control select2 product-select">
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            ...
                                            <strong style="margin-left: 13rem;"><small class="text-muted">الإجمالي الكلي : </small><span class="grand-total">{{ $item->raw_total }}</span></strong>
                                        </div>
                                    </div>
                                </div>
                                <br><hr>
                                ...
                                <div class="form-group col-md-12">
                                    <p onclick="toggleSection('expenses')" class="d-flex justify-content-between section-header" style="background: #DBDEE2; width: 100%;">
                                        <span class="p-1 font-weight-bold"><i class="fa fa-money"></i> المصروفات (<span id="rowExpensesCount">{{ count($productionMaterialItems) }}</span>)</span>
                                        <i class="feather icon-plus-circle p-1"></i>
                                    </p>
                                    <div id="expenses" style="display: none">
                                        <table class="table table-striped" id="ExpensesTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="expenses_production_stage_id[]" class="form-control select2 product-select">
                                                            <option value="" disabled selected>-- اختر المرحلة الانتاجية --</option>
                                                            @foreach ($stages as $stage)
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            ...
                                            <strong style="margin-left: 13rem;"><small class="text-muted">الإجمالي الكلي : </small><span class="expenses-grand-total">{{ $item->expenses_total }}</span></strong>
                                        </div>
                                    </div>
                                </div>
                                <br><hr>
                                ...
                                <div class="form-group col-md-12">
                                    <p onclick="toggleSection('manufacturing')" class="d-flex justify-content-between section-header" style="background: #DBDEE2; width: 100%;">
                                        <span class="p-1 font-weight-bold"><i class="feather icon-settings"></i> عمليات التصنيع (<span id="manufacturingCount">{{ count($productionMaterialItems) }}</span>)</span>
                                        <i class="feather icon-plus-circle p-1"></i>
                                    </p>
                                    <div id="manufacturing" style="display: none">
                                        <table class="table table-striped" id="manufacturingTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="manu_stage_id[]" class="form-control select2 product-select">
                                                            <option value="" disabled selected>-- اختر المرحلة الانتاجية --</option>
                                                            @foreach ($stages as $stage)
                                                                <option value="{{ $stage->id }}" {{ $item->manu_stage_id == $stage->id ? 'selected' : '' }}>{{ $stage->stage_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            ...
                                            <strong style="margin-left: 13rem;"><small class="text-muted">الإجمالي الكلي : </small><span class="manufacturing-grand-total">{{ $item->manu_total }}</span></strong>
                                        </div>
                                    </div>
                                </div>
                                <br><hr>
                                ...
                                <div class="form-group col-md-12">
                                    <p onclick="toggleSection('endLife')" class="d-flex justify-content-between section-header" style="background: #DBDEE2; width: 100%;">
                                        <span class="p-1 font-weight-bold"><i class="feather icon-trash-2"></i> المواد الهالكة (<span id="EndLifeCount">{{ count($productionMaterialItems) }}</span>)</span>
                                        <i class="feather icon-plus-circle p-1"></i>
                                    </p>
                                    <div id="endLife" style="display: none">
                                        <table class="table table-striped" id="EndLifeTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="end_life_stage_id[]" class="form-control select2 product-select">
                                                            <option value="" disabled selected>-- اختر المرحلة الانتاجية --</option>
                                                            <option value="1" {{ $item->end_life_stage_id == 1 ? 'selected' : '' }}>مرحلة 1</option>
                                                            <option value="2" {{ $item->end_life_stage_id == 2 ? 'selected' : '' }}>مرحلة 2</option>
                                                        </select>
                                                    </td>
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            ...
                                            <strong style="margin-left: 13rem;"><small class="text-muted">الإجمالي الكلي : </small><span class="end-life-grand-total">{{ $item->end_life_total }}</span></strong>
                                        </div>
                                    </div>
                                </div>
                                <br><hr>
                                ...
                                <div class="form-group col-md-6">
                                    <div class="d-flex justify-content-between p-1" style="background: #CCF5FA;">
                                        ...
                                        <strong class="total-cost">{{ $productionMaterial->last_total_cost }} ر.س</strong>
