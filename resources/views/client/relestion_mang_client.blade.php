                            ...
                            @foreach ($clients as $client)
                                <div class="client-item p-3 border-bottom hover-bg-light cursor-pointer"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div
                                            class="status-badge px-2 py-1 rounded
                        ...
                        <div class="card-body">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="details-tab" data-bs-toggle="tab" href="#details"
                                        ...
                                        <span id="notes-count-badge"
                                            class="badge bg-primary rounded-pill ms-1">{{ $ClientRelations->count() }}</span>
                                    </a>
                                </li>
                            ...
                            <div class="tab-content mt-3">
                                ...
                                <div class="tab-pane fade show active" id="details" role="tabpanel">
                                    ...
                                    <!-- نموذج إضافة ملاحظة -->
                                    <form id="clientForm" action="{{ route('clients.addnotes') }}" method="POST"
                                        ...
                                        <div class="card shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12">
                                                        <textarea class="form-control" name="description" rows="4" placeholder="اكتب ملاحظتك هنا..." required></textarea>
                                                    </div>
            ...
            @else bg-secondary @endif">
                                ...
                                <div class="tab-pane fade" id="balance" role="tabpanel">
                                    <div class="text-end mb-3">
                                        ...
                                        <a href="{{ route('MangRechargeBalances.create') }}" type="button"
            ...
            <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <form id="clientForm" action="{{ route('clients.mang_client_store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="card">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <select class="form-control" id="printing_method"
                                                            ...
                                                            <option value="2"
                                                                {{ old('printing_method') == 2 ? 'selected' : '' }}>ارسل
                                                                عبر
                                                                البريد</option>
                                                        </select>
                                                        <div class="form-control-position">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <select class="form-control" id="currency" name="currency">
                                                            <option value="SAR"
                                                                {{ old('currency') == 'SAR' ? 'selected' : '' }}>SAR
                                                            </option>
                                                            <option value="USD"
                                                                {{ old('currency') == 'USD' ? 'selected' : '' }}>USD
                                                            </option>
                                                            <option value="EUR"
                                                                {{ old('currency') == 'EUR' ? 'selected' : '' }}>EUR
                                                            </option>
                                                        </select>
                                                        <div class="form-control-position">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative has-icon-left">
                                                            <select class="form-control" name="client_type"
                                                                id="client_type">
                                                                <option value="1"
                                                                    {{ old('client_type') == 1 ? 'selected' : '' }}>عميل
                                                                    VIP
                                                                </option>
                                                                <option value="2"
                                                                    {{ old('client_type') == 2 ? 'selected' : '' }}>عميل
                                                                    عادي
                                                                    عادي</option>
                                                                {{-- --}}
                    ...
                    fetch(`/clients/clients_management/clients/search?query=${encodeURIComponent(searchValue)}`)
                        ...
                        .then(data => {
                            ...
                            if (data.length === 0) {
                                ...
                                data.forEach(client => {
                                    let status = client.status - > name ? client.latest_status.status :
                                        'غير محدد';
