                                                    ...
                                                    <table style="width: 100%; border-collapse: collapse; direction: rtl;">
                                                        <tr>
                                                            <td colspan="2" style="border: 1px solid #000; padding: 8px; text-align: right; direction: rtl;">
                                                                مختصر الحساب حتى {{ \Carbon\Carbon::now()->format('d/m/Y') }}
                                                            </td>
                                                            
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #000; padding: 8px;">الرصيد الافتتاحي</td>
                                                            <td style="border: 1px solid #000; padding: 8px; text-align: left;">{{$client->opening_balance ?? 0}} ﷼</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #000; padding: 8px;">الإجمالي</td>
                                                            <td style="border: 1px solid #000; padding: 8px; text-align: left;">  {{ $operationsPaginator->sum('deposit') }}  ﷼</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: 1px solid #000; padding: 8px;">المدفوع حتى تاريخه</td>
                                                            <td style="border: 1px solid #000; padding: 8px; text-align: left;">-{{ $operationsPaginator->sum('withdraw') }} ﷼</td>
                                                        </tr>
                                                       
                                                        <tr>
                                                            <td style="border: 1px solid #000; padding: 8px;">المبلغ المستحق</td>
                                                            <td style="border: 1px solid #000; padding: 8px; text-align: left;">{{$account->balance ?? 0}} ﷼</td>
                                                        </tr>
                                                    </table>
...
<table style="width: 100%; border-collapse: collapse; direction: rtl;">
    ...
    <tbody>  
        ...
        <tr style="font-weight: bold;">
            ...
            <td style="border: 1px solid #000; padding: 8px;">{{ number_format($account->balance ?? 0, 2) }} ر.س</td>
        </tr>
    </tbody>
</table>
                                                    </div>
