        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                    ...
                    <!-- الأزرار الرئيسية -->
                    <div class="dropdown mt-2 mt-md-0 d-md-none w-100">
                        <button type="button" class="btn btn-sm btn-outline-primary dropdown-toggle w-100 text-center" 
                        ...
                        <ul class="dropdown-menu dropdown-menu-start w-100">
                            ...
                            <li>
                                <a href="{{ route('CreditNotes.create') }}" class="dropdown-item d-inline-flex align-items-center">
                                    <i class="fas fa-plus me-1"></i> إنشاء إشعار دائن
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('questions.create') }}" class="dropdown-item d-inline-flex align-items-center">
                                    <i class="fas fa-file-invoice me-1"></i> إنشاء عرض سعر
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('invoices.create') }}" class="dropdown-item d-inline-flex align-items-center">
                                    <i class="fas fa-file-invoice me-1"></i> إنشاء فاتورة
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('Reservations.client', $client->id) }}" class="dropdown-item d-inline-flex align-items-center">
                            ...
                            <li>
                                <a href="{{ route('appointments.create') }}" class="dropdown-item d-inline-flex align-items-center">
                                    <i class="far fa-calendar-alt me-1"></i> ترتيب موعد
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('appointment.notes.create', $client->id) }}" class="dropdown-item d-inline-flex align-items-center">
                                    <i class="far fa-calendar-alt me-1"></i> إضافة ملاحظة/مرفق
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('clients.edit', $client->id) }}" class="dropdown-item d-inline-flex align-items-center">
                                            ...
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                <div class="dropdown d-block d-md-none">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <button class="dropdown-item filter-appointments" data-filter="{{ App\Models\Appointment::STATUS_COMPLETED }}">
                                                            تم <span class="badge badge-light">{{ $completedAppointments->count() }}</span>
                                                        </button>
                                                        <button class="dropdown-item filter-appointments" data-filter="{{ App\Models\Appointment::STATUS_IGNORED }}">
                                                            تم صرف النظر عنه <span class="badge badge-light">{{ $ignoredAppointments->count() }}</span>
                                                        </button>
                                                        <button class="dropdown-item filter-appointments" data-filter="{{ App\Models\Appointment::STATUS_PENDING }}">
                                                            تم جدولته <span class="badge badge-light">{{ $pendingAppointments->count() }}</span>
                                                        </button>
                                                        <button class="dropdown-item filter-appointments" data-filter="{{ App\Models\Appointment::STATUS_RESCHEDULED }}">
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    @foreach ($client->appointments as $appointment)
                                                                        <tr data-appointment-id="{{ $appointment->id }}" data-status="{{ $appointment->status }}" data-date="{{ $appointment->created_at->format('Y-m-d') }}">
                                                                            ...
                                                                            <td>
                                                                                <div class="dropdown">
                                                                                    <button class="btn btn-sm bg-gradient-info fa fa-ellipsis-v" type="button" id="dropdownMenuButton{{ $appointment->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
