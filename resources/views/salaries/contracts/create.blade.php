                ...
                <div class="card-body">
                    ...
                    <div class="form-body row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="feedback2" class="form-control" value="{{ $nextNumber }}"
                                   readonly disabled>
                    ...
                    <div class="form-body row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="job_title_id" class="form-control" id="job_title_id" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="job_level_id" class="form-control" id="job_level_id" required>
                    ...
                    <div class="form-body row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="" class="form-control" id="" name="parent_contract_id">
