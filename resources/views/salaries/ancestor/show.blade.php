                                ...
                                <tr>
                                    <td class="text-start" style="width: 50%">
                                            ...
                                            <div class="mt-1">
                                                <div style="width: fit-content;">
                                                    <div
                                                        ...
                                                        <div
                                                            style="border-bottom: 2px solid #ffc107; width: {{ ($ancestor->installment_amount / $ancestor->amount) * 100 }}%; position: absolute; bottom: -2px;">
                                                        </div>
                                                    ...
                                                    <div style="color: #666; font-size: 0.9em;">
                                                        <span>{{ number_format($ancestor->installment_amount, 2) }} ر.س
                                                            مدفوعة</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div>{{$ancestor->treasury->name  }}</div>
                                        </div>
                                    </td>
                                    <td class="text-start" style="width: 50%">
                                        <div class="mb-2">
