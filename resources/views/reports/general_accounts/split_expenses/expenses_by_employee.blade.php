...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0"> تقرير المصروفات حسبالموظف
                    </h2>
    ...
    <div class="container mt-5">
        ...
        <div class="card p-4 mb-3">
            <form action="{{ route('GeneralAccountReports.splitExpensesByEmployee') }}" method="GET">
        ...
        <!-- Chart Section -->
        <div class="card p-4 mb-3">
            <h5>مخطط الإجمالي مع الضريبة حسب الموظف</h5>
