            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="total-row">
                        ...
                        <td class="text-left">{{ number_format($invoices->sum('grand_total'), 2) }} ر.س</td>
                        <td colspan="3"></td>
                    </tr>
                </tbody>
            </table>
        ...
        @if ($payments->count() > 0)
            <table>
                ...
                <tbody>
                    ...
                    <tr class="total-row">
                        <td colspan="2">المجموع</td>
                        <td class="text-left">{{ number_format($payments->sum('amount'), 2) }} ر.س</td>
                        <td colspan="3"></td>
                    </tr>
                </tbody>
            </table>
        ...
        @if ($receipts->count() > 0)
            <table>
                ...
                <tbody>
                    ...
                    <tr class="total-row">
                        <td colspan="2">المجموع</td>
                        <td class="text-left">{{ number_format($receipts->sum('amount'), 2) }} ر.س</td>
                        <td colspan="2"></td>
                    </tr>
                </tbody>
            </table>
        ...
        @if ($expenses->count() > 0)
            <table>
                ...
                <tbody>
                    ...
                    <tr class="total-row">
                        <td colspan="2">المجموع</td>
                        <td class="text-left">{{ number_format($expenses->sum('amount'), 2) }} ر.س</td>
                        <td colspan="2"></td>
                    </tr>
                </tbody>
            </table>
