            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="filter-section">
                        <form method="GET" action="{{ route('salesReports.employeePaymentReport') }}">
                            <div class="row g-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3 d-flex align-items-end">
                                    ...
                                    <a href="{{route('salesReports.employeePaymentReport')}}" type="submit" class="btn btn-primary w-100">
                            ...
                            <tbody>
                                @forelse ($payments->groupBy(fn($p) => optional($p->invoice?->createdByUser)->id) as $employeeId => $createdByUser)
                                    ...
                                    @if ($employee)
                                        ...
                                        @foreach ($createdByUser as $payment)
                                            @php
