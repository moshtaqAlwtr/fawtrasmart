                ...
                <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3 d-flex align-items-end">
                                    <div class="d-flex w-100 gap-2">
                                        ...
                                        <a href="{{ route('salesReports.patyment') }}" class="btn btn-secondary flex-grow-1">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <div class="summary-card text-center">
                                ...
                                <div class="amount text-success">{{ number_format($totalPayments, 2) }} ر.س</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="summary-card text-center">
                        ...
                        <div class="col-md-4">
                            <div class="summary-card text-center">
                                ...
                                <div class="amount text-info">{{ number_format($payments->avg('amount') ?? 0, 2) }} ر.س</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="paymentsTable">
                            ...
                            <tbody>
                                @forelse ($groupedPayments as $periodKey => $periodData)
                                    @php
                                        $periodDisplay = '';
                                    ...
                                    @foreach($periodData['items'] as $payment)
                                        <tr>
                                            <td>{{ $periodDisplay }}</td>
                                            <td>{{ optional($payment->invoice->createdByUser)->name ?? 'غير محدد' }}</td>
                                    ...
                                    <tr class="period-total">
                                        ...
                                        <td class="text-end">{{ number_format($periodData['total_amount'], 2) }} ر.س</td>
                                        <td colspan="2">عدد المدفوعات: {{ $periodData['count'] }}</td>
                                    </tr>
                                @empty
                                    <tr>
