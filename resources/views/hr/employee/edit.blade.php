            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="first_name" class="form-control" placeholder="أدخل الاسم الأول" value="{{ old('first_name',$employee->first_name) }}">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="middle_name">الاسم الأوسط</label>
                        <input type="text" name="middle_name" class="form-control" placeholder="أدخل الاسم الأوسط" value="{{ old('middle_name',$employee->middle_name) }}">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="last_name">اللقب</label>
                        <input type="text" name="nickname" class="form-control" placeholder="أدخل اللقب" value="{{ old('nickname',$employee->nickname) }}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="email" name="email" class="form-control" id="email" placeholder="example@email.com" value="{{ old('email',$employee->email) }}">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="employee_type">نوع الموظف</label>
                        <select name="employee_type" class="form-control">
                            <option value="1" {{ old('employee_type',$employee->employee_type) == 1 ? 'selected' : '' }}>موظف</option>
                            <option value="2" {{ old('employee_type'.$employee->employee_type) == 2 ? 'selected' : '' }}>مستخدم</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="status" class="form-control" id="status" required>
                            <option value="1" {{ old('status',$employee->status) == 1 ? 'selected' : '' }}>نشط</option>
                            <option value="2" {{ old('status',$employee->status) == 2 ? 'selected' : '' }}>غير نشط</option>
                        </select>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <select name="language" class="form-control">
                            <option value="1" {{ old('language',$employee->language) == 1 ? 'selected' : '' }}>العربيه</option>
                            <option value="2" {{ old('language',$employee->language) == 2 ? 'selected' : '' }}>انجليزيه</option>
                        </select>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="gender">
                            ...
                            <option value="2" {{ old('gender',$employee->gender) == 2 ? 'selected' : '' }}>انثى</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="nationality_status">
                            ...
                            <option value="1" {{ old('nationality_status',$employee->nationality_status) == 1 ? 'selected' : '' }}>مواطن</option>
                            <option value="2" {{ old('nationality_status',$employee->nationality_status) == 2 ? 'selected' : '' }}>مقيم</option>
                            <option value="3" {{ old('nationality_status',$employee->nationality_status) == 3 ? 'selected' : '' }}>زائر</option>
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control select2" name="country">
                            ...
                            @foreach ($arabic_countries as $key => $country)
                                <option value="{{ $key }}" {{ old('country',$employee->country) == $key ? 'selected' : '' }}>
                                    {{ $country }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="mobile_number" value="{{ old('mobile_number',$employee->mobile_number) }}">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="phone">رقم الهاتف</label>
                        <input type="text" class="form-control" name="phone_number" value="{{ old('phone_number',$employee->phone_number) }}">
                    </div>
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="current_address_1" value="{{ old('current_address_1',$employee->current_address_1) }}">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="address2">عنوان 2</label>
                        <input type="text" class="form-control" name="current_address_2" value="{{ old('current_address_2',$employee->current_address_2) }}">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="region" value="{{ old('region',$employee->region) }}">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="postalCode">الرمز البريدي</label>
                        <input type="text" class="form-control" name="postal_code" value="{{ old('postal_code',$employee->postal_code) }}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="job_title_id">
                            ...
                            @foreach ($jobTitles as $jobTitle )
                                <option value="{{ $jobTitle->id }}" {{ old('job_title_id',$employee->job_title_id) == $jobTitle->id ? 'selected' : '' }}>{{ $jobTitle->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="job_level_id">
                            ...
                            @foreach ($jobLevels as $jobLevel )
                                <option value="{{ $jobLevel->id }}" {{ old('job_level_id',$employee->job_level_id) == $jobLevel->id ? 'selected' : '' }}>{{ $jobLevel->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="job_type_id">
                            ...
                            @foreach ($jobTypes as $jobType )
                                <option value="{{ $jobType->id }}" {{ old('job_type_id',$employee->job_type_id) == $jobType->id ? 'selected' : '' }}>{{ $jobType->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="direct_manager_id">
                            ...
                            @foreach($employees as $employee)
                                <option value="{{ $employee->id }}" {{ old('direct_manager_id',$employee->direct_manager_id) == $employee->id ? 'selected' : '' }}>{{ $employee->full_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select" id="month" name="custom_financial_month">
                            ...
                            @foreach ($months as $key => $value)
                                <option value="{{ $key }}" {{ old('custom_financial_month',$employee->custom_financial_month) == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select" id="day" name="custom_financial_day">
                            ...
                            @for ($i = 1; $i <= 31; $i++)
                                <option value="{{ $i }}" {{ old('custom_financial_day',$employee->custom_financial_day) == $i ? 'selected' : '' }}>
                                    {{ $i }}
                                </option>
                            @endfor
                        </select>
