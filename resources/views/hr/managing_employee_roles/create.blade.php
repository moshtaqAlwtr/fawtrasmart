                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_add_invoices" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_add_own_invoices" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_delete_all_invoices" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_delete_own_invoices" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_view_own_invoices" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_view_all_invoices" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_create_tax_report" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_change_seller" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_invoice_all_products" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_view_invoice_profit" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_add_credit_notice_all" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_add_credit_notice_own" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_invoice_date" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_add_payments_all" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_add_payments_own" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_payment_options" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_delete_all_payments" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_delete_own_payments" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_add_quote_own" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_view_all_quotes" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_view_own_quotes" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_delete_all_quotes" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_view_all_sales_orders" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_view_own_sales_orders" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_add_sales_order_all" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_add_sales_order_own" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_delete_all_sales_orders" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_delete_own_sales_orders" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_delete_all_credit_notices" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_edit_delete_own_credit_notices" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_view_all_credit_notices" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="sales_view_own_credit_notices" type="checkbox" class="permission-checkbox-sales permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="points_sale_edit_product_prices" type="checkbox" class="permission-checkbox-sales-points permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="points_sale_add_discount" type="checkbox" class="permission-checkbox-sales-points permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="points_sale_open_sessions_all" type="checkbox" class="permission-checkbox-sales-points permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="points_sale_open_sessions_own" type="checkbox" class="permission-checkbox-sales-points permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="points_sale_close_sessions_all" type="checkbox" class="permission-checkbox-sales-points permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="points_sale_close_sessions_own" type="checkbox" class="permission-checkbox-sales-points permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="points_sale_view_all_sessions" type="checkbox" class="permission-checkbox-sales-points permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="points_sale_view_own_sessions" type="checkbox" class="permission-checkbox-sales-points permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="points_sale_confirm_close_sessions_all" type="checkbox" class="permission-checkbox-sales-points permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="points_sale_confirm_close_sessions_own" type="checkbox" class="permission-checkbox-sales-points permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="vs-checkbox-con vs-checkbox-primary">
                                            <input name="customer_loyalty_points_managing_customer_bases" type="checkbox" class="permission-checkbox-customer-loyalty permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="vs-checkbox-con vs-checkbox-primary">
                                            <input name="customer_loyalty_points_redeem_loyalty_points" type="checkbox" class="permission-checkbox-customer-loyalty permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1">
                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                        <input name="targeted_sales_commissions_manage_sales_periods" type="checkbox" class="targeted-sales-commissions permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                ...
                                <div class="col-md-6 mb-1">
                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                        <input name="targeted_sales_commissions_view_all_sales_commissions" type="checkbox" class="targeted-sales-commissions permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                ...
                                <div class="col-md-6 mb-1">
                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                        <input name="targeted_sales_commissions_manage_commission_rules" type="checkbox" class="targeted-sales-commissions permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-2">
                                        <input name="products_add_product" type="checkbox" class="select-all-products permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-2">
                                        <input name="products_view_all_products" type="checkbox" class="select-all-products permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-2">
                                        <input name="products_view_own_products" type="checkbox" class="select-all-products permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-2">
                                        <input name="products_edit_delete_all_products" type="checkbox" class="select-all-products permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-2">
                                        <input name="products_edit_delete_own_products" type="checkbox" class="select-all-products permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-2">
                                        <input name="products_view_price_groups" type="checkbox" class="select-all-products permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-2">
                                        <input name="products_add_edit_price_groups" type="checkbox" class="select-all-products permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-2">
                                        <input name="products_delete_price_groups" type="checkbox" class="select-all-products permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                        <input name="management_of_insurance_agents" type="checkbox" class="select-all-insurances permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="client_follow_up_add_notes_attachments_appointments_all" type="checkbox" class="select-all-client-follow-up permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="client_follow_up_add_notes_attachments_appointments_own" type="checkbox" class="select-all-client-follow-up permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="client_follow_up_edit_delete_notes_attachments_appointments_all" type="checkbox" class="select-all-client-follow-up permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="client_follow_up_edit_delete_notes_attachments_appointments_own" type="checkbox" class="select-all-client-follow-up permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="client_follow_up_view_notes_attachments_appointments_all" type="checkbox" class="select-all-client-follow-up permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="client_follow_up_view_notes_attachments_appointments_assigned" type="checkbox" class="select-all-client-follow-up permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="client_follow_up_view_notes_attachments_appointments_own" type="checkbox" class="select-all-client-follow-up permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="client_follow_up_assign_clients_to_employees" type="checkbox" class="select-all-client-follow-up permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="clients_add_client" type="checkbox" class="select-all-customers permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="clients_view_all_clients" type="checkbox" class="select-all-customers permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="clients_view_own_clients" type="checkbox" class="select-all-customers permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="clients_edit_delete_all_clients" type="checkbox" class="select-all-customers permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="clients_edit_delete_own_clients" type="checkbox" class="select-all-customers permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="clients_view_all_activity_logs" type="checkbox" class="select-all-customers permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="clients_view_own_activity_log" type="checkbox" class="select-all-customers permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="clients_edit_client_settings" type="checkbox" class="select-all-customers permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="clients_view_all_reports" type="checkbox" class="select-all-customers permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="clients_view_own_reports" type="checkbox" class="select-all-customers permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="points_credits_packages_manage" type="checkbox" class="select-all-points-balances permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="points_credits_credit_recharge_manage" type="checkbox" class="select-all-points-balances permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="points_credits_credit_usage_manage" type="checkbox" class="select-all-points-balances permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="points_credits_credit_settings_manage" type="checkbox" class="select-all-points-balances permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="membership_management" type="checkbox" class="select-all-memberships permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="membership_setting_management" type="checkbox" class="select-all-memberships permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="customer_attendance_display" type="checkbox" class="select-all-customer-attendance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="customer_attendance_manage" type="checkbox" class="select-all-customer-attendance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="employees_add" type="checkbox" class="select-all-employees permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="employees_edit_delete" type="checkbox" class="select-all-employees permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="employees_roles_add" type="checkbox" class="select-all-employees permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="employees_roles_edit" type="checkbox" class="select-all-employees permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="employees_view_profile" type="checkbox" class="select-all-employees permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="hr_system_management" type="checkbox" class="select-all-organizational-structure permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_loans_manage" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_payroll_view" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_payroll_create" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_payroll_approve" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_payroll_edit" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_payroll_delete" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_contracts_notifications" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_contracts_edit_delete_own" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_payroll_settings_manage" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_payroll_view_own" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_payroll_delete_all" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_payroll_payment" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_contracts_receive_notifications" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_contracts_view_all" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_contracts_edit_delete_all" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="salaries_contracts_create" type="checkbox" class="select-all-salaries permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_online" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_pull_from_device" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_view_all" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_settings_manage" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_delete" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_edit_days" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_view_own" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_change_status" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_report_view" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_leave_requests_edit_delete_own" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_leave_requests_view_own" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_leave_requests_approve_reject" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_self_registration" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_import" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_view_own_records" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_inventory_permissions_manage" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_calculate_days" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_create_book" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_view_other_books" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_attendance_delete_books" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_leave_requests_add" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_leave_requests_edit_delete_all" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="staff_leave_requests_view_all" type="checkbox" class="select-all-staff-attendance permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="d-flex flex-wrap">
                                    <div class="vs-checkbox-con vs-checkbox-primary me-1">
                                        <input name="orders_management" type="checkbox" class="select-all-orders permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary me-1">
                                        <input name="orders_setting_management" type="checkbox" class="select-all-orders permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_inventory_permission_add" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_inventory_permission_view" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_inventory_price_edit" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_purchase_invoices_view_own" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_suppliers_add" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_suppliers_view_all" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_suppliers_edit_delete_all" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_inventory_edit_quantity" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_inventory_transfer" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_inventory_permission_edit" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_inventory_view_price" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_purchase_invoice_add" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_purchase_invoice_edit_delete_own" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_purchase_invoice_edit_delete_all" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_purchase_invoices_view_all" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_suppliers_view_created" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_allow_sale_below_min_price" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_inventory_monitor" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="inv_manage_suppliers_edit_delete_own" type="checkbox" class="select-all-inventory-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="purchase_cycle_orders_manage" type="checkbox" class="select-all-procurement-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="purchase_cycle_quotes_manage" type="checkbox" class="select-all-procurement-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="purchase_cycle_quotes_to_orders" type="checkbox" class="select-all-procurement-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="purchase_cycle_order_to_invoice" type="checkbox" class="select-all-procurement-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="purchase_cycle_orders_approve_reject" type="checkbox" class="select-all-procurement-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="purchase_cycle_quotes_approve_reject" type="checkbox" class="select-all-procurement-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="purchase_cycle_orders_manage_orders" type="checkbox" class="select-all-procurement-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="supply_orders_view_all" type="checkbox" class="select-all-supply-order-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="supply_orders_add" type="checkbox" class="select-all-supply-order-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="supply_orders_edit_delete_all" type="checkbox" class="select-all-supply-order-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="supply_orders_edit_delete_own" type="checkbox" class="select-all-supply-order-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="supply_orders_update_status" type="checkbox" class="select-all-supply-order-management permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                    ...
                                    <div class="panel-body">
                                        <div class="l-flex-row">
                                            <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                                <input name="supply_orders_view_own" type="checkbox" class="select-all-supply-order-management permission-main-checkbox">
                                                <span class="vs-checkbox">
                                                    <span class="vs-checkbox--check">
                                                        <i class="vs-icon feather icon-check"></i>
                                                    </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="track_time_add_employee_work_hours" type="checkbox" class="select-all-track-time permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="track_time_edit_other_employees_work_hours" type="checkbox" class="select-all-track-time permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="track_time_edit_delete_all_projects" type="checkbox" class="select-all-track-time permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="track_time_edit_delete_all_activities" type="checkbox" class="select-all-track-time permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="track_time_view_other_employees_work_hours" type="checkbox" class="select-all-track-time permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="track_time_add_new_project" type="checkbox" class="select-all-track-time permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="track_time_add_new_activity" type="checkbox" class="select-all-track-time permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="rental_unit_manage_rental_settings" type="checkbox" class="select-all-rental-unit-management permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="rental_unit_manage_booking_orders" type="checkbox" class="select-all-rental-unit-management permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="rental_unit_view_booking_orders" type="checkbox" class="select-all-rental-unit-management permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_add_new_assets" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_view_cost_centers" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_manage_cost_centers" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_manage_closed_periods" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_view_closed_periods" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_manage_journal_entries" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_view_all_journal_entries" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_view_own_journal_entries" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_add_edit_delete_all_journal_entries" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_add_edit_delete_own_journal_entries" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="g_a_d_r_add_edit_delete_draft_journal_entries" type="checkbox" class="select-all-general-accounts-daily-restrictions permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_add_expense" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_edit_delete_all_expenses" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_edit_delete_own_expenses" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_view_all_expenses" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_view_own_expenses" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_add_edit_delete_draft_expenses" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_edit_default_cashbox" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_view_own_cashboxes" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_add_revenue" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_edit_delete_all_receipts" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_edit_delete_own_receipts" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_view_all_receipts" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_view_own_receipts" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_add_edit_delete_draft_revenue" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="finance_add_revenue_expense_category" type="checkbox" class="select-all-finance permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="check_cycle_add_checkbook" type="checkbox" class="select-all-check-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="check_cycle_view_checkbook" type="checkbox" class="select-all-check-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="check_cycle_edit_delete_checkbook" type="checkbox" class="select-all-check-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="check_cycle_manage_received_checks" type="checkbox" class="select-all-check-cycle permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="settings_edit_general_settings" type="checkbox" class="select-all-settings permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="settings_edit_tax_settings" type="checkbox" class="select-all-settings permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                            <input name="settings_view_own_reports" type="checkbox" class="select-all-settings permission-main-checkbox">
                                            <span class="vs-checkbox">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="online_store_content_management" type="checkbox" class="select-all-online-store permission-main-checkbox">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="l-flex-row">
                                    ...
                                    <div class="vs-checkbox-con vs-checkbox-primary mb-1">
                                        <input name="employee_view_his_salary_slip" type="checkbox" class="select-all-salaries-employee">
                                        <span class="vs-checkbox">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
