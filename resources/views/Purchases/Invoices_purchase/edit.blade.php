...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0"> تعديل فاتورة مشتريات</h2>
    ...
    <div class="content-body">
        <form id="invoice-form" action="{{ route('invoicePurchases.update', $purchaseRentalInvoice->id) }}" method="post">
            @csrf
            @method('PUT')
            @if ($errors->any())
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="date" name="date"
                                                    value="{{ old('date', $purchaseRentalInvoice->date) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" type="text" name="terms"
                                                    value="{{ old('terms', $purchaseRentalInvoice->terms) }}">
                                            </div>
                                            <div class="col-md-2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="account_id" class="form-control select2" id=""
                                                    value="{{ old('account_id', $purchaseRentalInvoice->account_id) }}">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <select name="items[0][discount_type]" class="form-control discount-type"
                                                    value="{{ old('discount_type', $item->discount_type) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="discount_value" class="form-control"
                                        value="{{ old('discount_value', $purchaseRentalInvoice->discount_value) }}"
                                        min="0" step="0.01">
                            ...
                            <div class="col-md-3 text-end">
                                <div class="input-group">
                                    <input type="number" id="advanced-payment" class="form-control"
                                        value="{{ old('advance_payment', $purchaseRentalInvoice->advance_payment) }}"
                            ...
                            <div class="card-body py-2 align-items-right">
                                <div class="d-flex justify-content-start" style="direction: rtl;">
                                    <div class="form-check">
                                        <input class="form-check-input toggle-check" type="checkbox" name="is_paid"
                                            value="{{ old('is_paid', $purchaseRentalInvoice->is_paid) }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="payment_method"
                                                value="{{ old('payment_method', $purchaseRentalInvoice->payment_method) }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="reference_number"
                                                {{ old('reference_number', $purchaseRentalInvoice->reference_number) }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" name="shipping_cost" id="shipping"
                                    value="{{ old('   shipping_cost', $purchaseRentalInvoice->shipping_cost) }}"
                                    min="0" step="0.01">
                            </div>
                        </div>
                    </div>
