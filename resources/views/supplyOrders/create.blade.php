...
@section('content')
    ...
    <div class="content-body">
        <div class="container-fluid">
            <form class="form-horizontal" action="{{ route('SupplyOrders.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-body row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id="supply_order_name" name="name"
                                           ...
                                           value="{{ old('supply_order_name') }}">
                                    @error('supply_order_name')
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id="supply_order_number" name="supply_order_number"
                                           ...
                                           value="{{ old('supply_order_number', $supply_order_number) }}"
                                           readonly>
                            ...
                            <div class="form-body row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select id="currency" name="currency" class="form-control">
                                        <option value="1" {{ old('currency', '1') == '1' ? 'selected' : '' }}>SAR</option>
                                        <option value="2" {{ old('currency') == '2' ? 'selected' : '' }}>USD</option>
                                        <option value="3" {{ old('currency') == '3' ? 'selected' : '' }}>EUR</option>
                                        <option value="4" {{ old('currency') == '4' ? 'selected' : '' }}>GBP</option>
                                        <option value="5" {{ old('currency') == '5' ? 'selected' : '' }}>CNY</option>
                                    </select>
                                    @error('currency')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <textarea id="product_details" name="product_details"
                                          class="form-control" rows="4">{{ old('product_details') }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea id="shipping_address" name="shipping_address"
                                          class="form-control" rows="4">{{ old('shipping_address') }}</textarea>
    ...
    @include('supplyOrders.custom_fields_modal')
@endsection
