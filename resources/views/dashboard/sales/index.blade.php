                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h6 class="text-muted">إجمالي العملاء: <span class="text-dark font-weight-bold">{{ $totalClients ?? 0 }}</span></h6>
                        </div>
                    </div>
    ...
    <div class="col-lg-4 col-12 mb-4">
        <div class="card shadow-lg border-0 rounded-4 h-100">
            <div class="card-body">
                ...
                <h3 class="text-success font-weight-bold mb-3">{{ number_format($Invoice, 2) ?? 0 }} ﷼</h3>
                            ...
                            @foreach ($branchesPerformance->take(3) as $index => $branch)
                                ...
                                <div class="mb-4 position-relative">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <span class="badge rounded-circle text-white fw-bold" style="background-color: {{ $color }}; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;">
                                            {{ $index + 1 }}
                                        </span>
                                    </div>

                                    <div class="progress mb-1" style="height: 8px; direction: rtl; background-color: #eee;">
                                        <div class="progress-bar" role="progressbar" style="width: {{ min($percentage, 100) }}%;" aria-valuenow="{{ $percentage }}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                            ...
                            @foreach ($regionPerformance->take(3) as $index => $region)
                                ...
                                <div class="mb-4">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <span class="badge text-white fw-bold rounded-circle" style="background-color: {{ $color }}; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;">
                                            {{ $index + 1 }}
                                        </span>
                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="progress" style="width: 100%; height: 8px;">
                                                    <div class="progress-bar bg-success" role="progressbar" style="width: {{ $card['percentage'] }}%;" aria-valuenow="{{ $card['percentage'] }}" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.addEventListener("DOMContentLoaded", function() {
                var options = {
                    ...
                    series: [{ name: 'المبيعات', data: @json($groups->pluck('total_sales')) }],
                    xaxis: { categories: @json($groups->pluck('Region.name')) }
                };
