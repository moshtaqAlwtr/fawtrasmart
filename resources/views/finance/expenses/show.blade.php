        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div>
                        <strong>مصروف</strong> | <small>{{ $expense->code }} #</small> | <span class="badge badge-pill badge badge-success">اصدر</span>
                    </div>
        ...
        <div class="container" style="max-width: 1200px">
            <div class="card">
                <div class="card-title p-2">
                    <a href="{{ route('expenses.edit',$expense->id) }}" class="btn btn-outline-primary btn-sm">تعديل <i class="fa fa-edit"></i></a>
                    <a href="#" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#modal_DELETE{{ $expense->id }}">حذف <i class="fa fa-trash"></i></a>
                                            ...
                                            <tr>
                                                <td style="width: 50%">
                                                    @if ($expense->attachments)
                                                        <img src="{{ asset('assets/uploads/expenses/'.$expense->attachments) }}" alt="img" width="150">
                                                    @else
                                                ...
                                                <td>
                                                    <strong> الكود </strong>: {{ $expense->code }}#
                                                    <br><br>
                                                    <strong>المبلغ </strong>: {{ $expense->amount }}
                                                    <br><br>
                                                    <strong>التاريخ </strong>: {{ $expense->date }}
                                                    <br><br>
                                                    <strong>خزينة </strong>: {{ $expense->store_id }}
                                                    <br><br>
                                                    <strong>المورد </strong>: {{ $expense->vendor_id }}
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
