...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">سند قبض</h2>
    ...
    <div class="content-body">
        ...
        <div class="card">
            <div class="card-body">
                <form id="incomes_form" action="{{ route('incomes.update',$income->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="row">
                        <div class="form-group col-md-4">
                            <label for="amount">المبلغ <span style="color: red">*</span></label>
                            <input type="text" class="form-control form-control-lg py-3" id="amount" placeholder="ر.س 0.00" name="amount" value="{{ old('amount',$income->amount) }}">
                            @error('amount')
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="code-number" name="code" value="{{ old('code',$income->code) }}">
                            @error('code')
                            <span class="text-danger" id="basic-default-name-error" class="error">
                                {{ $message }}
                            </span>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="unit" class="form-control" name="unit_id">
                                ...
                                <option value="1" {{ old('unit_id',$income->unit_id) == 1 ? 'selected' : '' }}>وحدة 1</option>
                                <option value="2" {{ old('unit_id',$income->unit_id) == 2 ? 'selected' : '' }}>وحدة 2</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <select id="category" class="form-control" name="incomes_category_id">
                                ...
                                @foreach($incomes_categories as $incomes_category)
                                    <option value="{{ $incomes_category->id }}" {{ old('incomes_category_id',$income->incomes_category_id) == $incomes_category->id ? 'selected' : '' }}>{{ $incomes_category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <select id="seller" class="form-control" name="vendor_id">
                                ...
                                <option value="1" {{ old('vendor_id',$income->vendor_id) == 2 ? 'selected' : '' }}>بائع 1</option>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="warehouse" class="form-control" name="store_id">
                                ...
                                <option value="2" {{ old('store_id',$income->store_id) == 2 ? 'selected' : '' }}>فرعي</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="min-limit" name="sup_account" value="{{ old('sup_account',$income->sup_account) }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="items">المورد</label>
                            <select id="items" class="form-control" name="vendor_id">
                                <option selected disabled>اختر مورد</option>
                                <option value="1" {{ old('vendor_id',$income->vendor_id) == 2 ? 'selected' : '' }}>مورد 1</option>
                                <option value="2" {{ old('vendor_id',$income->vendor_id) == 2 ? 'selected' : '' }}>مورد 2</option>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select id="tax1" class="form-control" name="tax1">
                                    ...
                                    <option value="1" {{ old('tax1',$income->tax1) == 1 ? 'selected' : '' }}>ضريبة 1</option>
                                    <option value="2" {{ old('tax1',$income->tax1) == 2 ? 'selected' : '' }}>ضريبة 2</option>
                                </select>
                                <input type="text" class="form-control mt-2" placeholder="المبلغ" name="tax1_amount" value="{{ old('tax1_amount',$income->tax1_amount) }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="tax2">الضريبة الثانية</label>
                                <select id="tax2" class="form-control" name="tax2">
                                    <option selected disabled>-</option>
                                    <option value="1" {{ old('tax2',$income->tax2) == 1 ? 'selected' : '' }}>ضريبة 1</option>
                                    <option value="2" {{ old('tax2',$income->tax2) == 2 ? 'selected' : '' }}>ضريبة 2</option>
                                </select>
                                <input type="text" class="form-control mt-2" placeholder="المبلغ" name="tax2_amount" value="{{ old('tax2_amount',$income->tax2_amount) }}">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="checkbox" id="checkbox" name="is_recurring" {{ $income->is_recurring == 1 ? 'checked' : '' }}>
                                    </div>
                                </div>
