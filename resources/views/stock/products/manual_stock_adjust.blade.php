            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('products.add_manual_stock_adjust',$product->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-2">
                                       ...
                                       @if($role)
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="unit_price" value="{{ old('unit_price', $product->sale_price) }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="store_house_id">
                                                    @foreach ($storehouses as $storehouse)
                                                        <option value="{{ $storehouse->id }}" {{ old('store_house_id') == $storehouse->id ? 'selected' : '' }}>{{ $storehouse->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="subaccount" value="{{ old('subaccount') }}">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
