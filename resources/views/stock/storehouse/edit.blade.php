    ...
    <div class="content-body">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form id="products_form" class="form form-vertical" action="{{ route('storehouse.update',$storehouse->id) }}" method="POST">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <input type="text" id="first-name-icon" class="form-control" name="name" placeholder="اسم المستودع"  value="{{ old('name',$storehouse->name) }}">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="basicSelect" name="status">
                                            <option value="0" {{ old('status',$storehouse->status) == 0 ? 'selected' : '' }}>نشط</option>
                                            <option value="1" {{ old('status',$storehouse->status) == 1 ? 'selected' : '' }}>غير نشط</option>
                                            <option value="2" {{ old('status',$storehouse->status) == 2 ? 'selected' : '' }}>موقوف</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <textarea name="shipping_address" class="form-control" rows="2">{{ old('shipping_address',$storehouse->shipping_address) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    <fieldset class="checkbox">
                                        <div class="vs-checkbox-con vs-checkbox-primary">
                                            <input type="checkbox" name="major" {{ $storehouse->major == 1 ? 'checked' : '' }} >
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="view_permissions" name="view_permissions">
                                                <option selected value="0" {{ old('view_permissions',$storehouse->view_permissions) == 0 ? 'selected' : '' }}>الكل</option>
                                                <option value="1" {{ old('view_permissions',$storehouse->view_permissions) == 1 ? 'selected' : '' }}>موظف محدد</option>
                                                <option value="2" {{ old('view_permissions',$storehouse->view_permissions) == 2 ? 'selected' : '' }}>دور وظيفي محدد</option>
                                                <option value="3" {{ old('view_permissions',$storehouse->view_permissions) == 3 ? 'selected' : '' }}>فرع محدد</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="crate_invoices_permissions" name="crate_invoices_permissions">
                                                <option selected value="0" {{ old('crate_invoices_permissions',$storehouse->crate_invoices_permissions) == 0 ? 'selected' : '' }}>الكل</option>
                                                <option value="1" {{ old('crate_invoices_permissions',$storehouse->crate_invoices_permissions) == 1 ? 'selected' : '' }}>موظف محدد</option>
                                                <option value="2" {{ old('crate_invoices_permissions',$storehouse->crate_invoices_permissions) == 2 ? 'selected' : '' }}>دور وظيفي محدد</option>
                                                <option value="3" {{ old('crate_invoices_permissions',$storehouse->crate_invoices_permissions) == 3 ? 'selected' : '' }}>فرع محدد</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="edit_stock_permissions" name="edit_stock_permissions">
                                                <option selected value="0" {{ old('edit_stock_permissions',$storehouse->edit_stock_permissions) == 0 ? 'selected' : '' }}>الكل</option>
                                                <option value="1" {{ old('edit_stock_permissions',$storehouse->edit_stock_permissions) == 1 ? 'selected' : '' }}>موظف محدد</option>
                                                <option value="2" {{ old('edit_stock_permissions',$storehouse->edit_stock_permissions) == 2 ? 'selected' : '' }}>دور وظيفي محدد</option>
                                                <option value="3" {{ old('edit_stock_permissions',$storehouse->edit_stock_permissions) == 3 ? 'selected' : '' }}>فرع محدد</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group" style='display: none' id="employee_id">
                                            ...
                                            <select class="form-control" name="v_employee_id">
                                                @foreach ($employees as $employee)
                                                    <option value="{{ $employee->id }}" {{ old('v_employee_id', $storehouse->employee_id) == $employee->id ? 'selected' : '' }}>{{ $employee->full_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group" style='display: none' id="functional_role_id">
                                            ...
                                            <select class="form-control" name="v_functional_role_id">
                                                @foreach ($job_roles as $job_role)
                                                    <option value="{{ $job_role->id }}" {{ old('v_functional_role_id', $storehouse->functional_role_id) == $job_role->id ? 'selected' : '' }}>{{ $job_role->role_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group" style='display: none' id="branch_id">
                                            ...
                                            <select class="form-control" name="v_branch_id">
                                                @foreach ($branches as $branch)
                                                    <option value="{{ $branch->id }}" {{ old('v_branch_id', $storehouse->branch_id) == $branch->id ? 'selected' : '' }}>{{ $branch->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group" style='display: none' id="1employee_id">
                                            ...
                                            <select class="form-control" name="c_employee_id">
                                                @foreach ($employees as $employee)
                                                    <option value="{{ $employee->id }}" {{ old('c_employee_id', $storehouse->employee_id) == $employee->id ? 'selected' : '' }}>{{ $employee->full_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group" style='display: none' id="1functional_role_id">
                                            ...
                                            <select class="form-control" name="c_functional_role_id">
                                                @foreach ($job_roles as $job_role)
                                                    <option value="{{ $job_role->id }}" {{ old('c_functional_role_id', $storehouse->functional_role_id) == $job_role->id ? 'selected' : '' }}>{{ $job_role->role_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group" style='display: none' id="1branch_id">
                                            ...
                                            <select class="form-control" name="c_branch_id">
                                                @foreach ($branches as $branch)
                                                    <option value="{{ $branch->id }}" {{ old('c_branch_id', $storehouse->branch_id) == $branch->id ? 'selected' : '' }}>{{ $branch->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group" style='display: none' id="2employee_id">
                                            ...
                                            <select class="form-control" name="e_employee_id">
                                                @foreach ($employees as $employee)
                                                    <option value="{{ $employee->id }}" {{ old('e_employee_id', $storehouse->employee_id) == $employee->id ? 'selected' : '' }}>{{ $employee->full_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group" style='display: none' id="2functional_role_id">
                                            ...
                                            <select class="form-control" name="e_functional_role_id">
                                                @foreach ($job_roles as $job_role)
                                                    <option value="{{ $job_role->id }}" {{ old('e_functional_role_id', $storehouse->e_functional_role_id) == $job_role->id ? 'selected' : '' }}>{{ $job_role->role_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group" style='display: none' id="2branch_id">
                                            ...
                                            <select class="form-control" name="e_branch_id">
                                                @foreach ($branches as $branch)
                                                    <option value="{{ $branch->id }}" {{ old('e_branch_id', $storehouse->branch_id) == $branch->id ? 'selected' : '' }}>{{ $branch->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
