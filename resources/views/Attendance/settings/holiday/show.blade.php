...
@section('content')
    ...
    <div class="card">
        <div class="card-title p-2">
            <a href="#" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#modal_DELETE{{ $holiday_list->id }}">حذف <i class="fa fa-trash"></i></a>
            <a href="{{ route('holiday_lists.edit',$holiday_list->id) }}" class="btn btn-outline-primary btn-sm">تعديل <i class="fa fa-edit"></i></a>
            <a href="{{ route('holiday_lists.holyday_employees',$holiday_list->id) }}" class="btn btn-outline-success btn-sm">قم بالتخصيص للموظفين <i class="fa fa-users"></i></a>
        </div>
        <div class="card-body">
                                ...
                                <div class="row">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <p><small>الاسم </small>: </p><strong> {{ $holiday_list->name }}</strong>
                                                </td>
                                                <td>
                                                    <p><small>عدد العطلات المختارة </small>: </p><strong> {{ $holiday_list->holidays()->count() }}</strong>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('holiday_lists.delete',$holiday_list->id) }}" class="btn btn-danger">تأكيد</a>
                </div>
            </div>
        </div>
    </div>
