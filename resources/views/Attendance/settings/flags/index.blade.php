...
@section('content')
    ...
    <div class="card-body">
        ...
        <div class="col-md-6 text-md-start">
            ...
            <div class="col-md-6">
                <a href="{{ route('attendance.settings.flags.create') }}" class="btn btn-outline-success">
                    <i class="fa fa-plus me-2"></i>أضف قواعد الحضور
                </a>
            </div>
        </div>
        ...
        <form id="search-form" method="GET">
            <div class="row">
                <div class="col-6">
                    <label for="employee-search" class="form-label">البحث بأسم قواعد الحضور</label>
                    <input 
                        type="text" 
                        class="form-control" 
                        id="employee-search" 
                        name="employee" 
                        placeholder="البحث باسم قواعد الحضور أو المعرف ">
                </div>
                <div class="col-6">
