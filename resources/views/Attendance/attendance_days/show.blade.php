...
@section('content')
                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ \Carbon\Carbon::parse($attendance_day->attendance_date)->locale('ar')->translatedFormat('l, d/m/Y') }}</li>
    ...
    <div class="card">
        <div class="card-title p-2">
            <a href="#" class="btn btn-outline-danger btn-sm waves-effect waves-light" data-toggle="modal" data-target="#modal_DELETE{{ $attendance_day->id }}">حذف <i class="fa fa-trash"></i></a>
            <a href="{{ route('attendanceDays.edit',$attendance_day->id) }}" class="btn btn-outline-primary btn-sm waves-effect waves-light">تعديل <i class="fa fa-edit"></i></a>
        </div>
        <div class="card-body">
                                ...
                                <div class="row">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <p><small>اسم الموظف</small>: </p><strong>{{ $attendance_day->employee->full_name }}</strong>
                                                </td>
                                                <td>
                                                    <p><small>الرقم التعريفي للموظف</small>: </p><strong># {{ $attendance_day->employee->id }}</strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <p><small>رقم دفتر الحضور</small>: </p><strong># {{ $attendance_day->id }}</strong>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    @if($attendance_day->status == 'present')
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <p><small>بداية الوردية </small>: </p><strong>{{ $attendance_day->start_shift }}</strong>
                                                    </td>
                                                    <td>
                                                        <p><small>نهاية الوردية</small>: </p><strong>{{ $attendance_day->end_shift }}</strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <p><small>تسجيل الدخول </small>: </p><span>{{ $attendance_day->login_time }}</span>
                                                    </td>
                                                    <td>
                                                        <p><small>تسجيل الخروج </small>: </p><strong>{{ $attendance_day->logout_time }}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    @php
                                                        ...
                                                        $StartShift = \Carbon\Carbon::parse($attendance_day->start_shift);
                                                    ...
                                                    @endphp
                                                    <td>
                                                        <p><small>ساعات العمل المتوقعة </small>: </p><strong>{{ $totalDurationDefault->h }} ساعة و {{ $totalDurationDefault->i }} دقيقة</strong>
                                                    </td>
                                                    <td>
                                                        <p><small>ساعات العمل الفعلية </small>: </p><strong>{{ $totalDuration->h }} ساعة و {{ $totalDuration->i }} دقيقة</strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
