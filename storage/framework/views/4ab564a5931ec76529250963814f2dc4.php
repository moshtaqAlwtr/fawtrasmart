...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('groups.group_client_update', $regionGroup->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" id="name" name="name" class="form-control" placeholder="المجموعة"
                            value="<?php echo e(old('name', $regionGroup->name)); ?>" required>
                    </div>
                        ...
                        <select name="branch_id" id="branch_id" class="form-control select2">
                            <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($branch->id); ?>"
                                    <?php echo e($branch->id == $regionGroup->branch_id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="directions_id" class="form-control">
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtramsmart\fawtra\resources\views/client/groups/group_client_edit.blade.php ENDPATH**/ ?>