                                    ...
                                    <select name="added_by" class="form-control" id="added_by">
                                        ...
                                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($employee->id); ?>"
                                                <?php echo e(request('added_by') == $employee->id ? 'selected' : ''); ?>>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton303">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item text-danger" href="#"
                                                            data-toggle="modal"
                                                            data-target="#modal_DELETE<?php echo e($income->id); ?>">
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/finance/incomes/index.blade.php ENDPATH**/ ?>