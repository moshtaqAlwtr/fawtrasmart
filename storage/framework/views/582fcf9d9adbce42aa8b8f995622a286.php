...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
        <form id="invoice-form" action="<?php echo e(route('CreditNotes.store')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <?php if($errors->any()): ?>
                                ...
                                <div class="row add_item">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <label class="form-control"><?php echo e($Credits_number); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="date" name="credit_date" value="<?php echo e(old('credit_date', date('Y-m-d'))); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="date" name="release_date" value="<?php echo e(old('release_date', date('Y-m-d'))); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/sales/creted_note/create.blade.php ENDPATH**/ ?>