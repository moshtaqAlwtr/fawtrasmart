                ...
                <div class="card-body">
                    <form class="form" id="searchForm" method="GET" action="<?php echo e(route('invoices.index')); ?>">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="client_id" class="form-control select2" id="client_id">
                                    ...
                                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($client->id); ?>" data-client-number="<?php echo e($client->id); ?>" data-client-name="<?php echo e($client->trade_name); ?>" <?php echo e(request('client_id') == $client->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="status" class="form-control" id="status">
                                    ...
                                    <option value="1" <?php echo e(request('Payment_status') == 1 ? 'selected' : ''); ?>> مدفوعة بالكامل</option>
                                    <option value="2" <?php echo e(request('Payment_status') == 2 ? 'selected' : ''); ?>>مدفوعة جزئيًا</option>
                                    <option value="3" <?php echo e(request('Payment_status') == 3 ? 'selected' : ''); ?>>غير مدفوعة بالكامل</option>
                                    <option value="4" <?php echo e(request('Payment_status') == 4 ? 'selected' : ''); ?>>مرتجع</option>
                                    <option value="5" <?php echo e(request('Payment_status') == 5 ? 'selected' : ''); ?>>مرتجع جزئي</option>
                                    <option value="6" <?php echo e(request('Payment_status') == 6 ? 'selected' : ''); ?>>مدفوع بزيادة</option>
                                    <option value="7" <?php echo e(request('Payment_status') == 7 ? 'selected' : ''); ?>>مستحقة الدفع</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-actions mt-2">
                            ...
                            <a href="<?php echo e(route('invoices.index')); ?>" type="reset" class="btn btn-outline-warning">إلغاء</a>
                        </div>
                    </form>
                </div>
            </div>
                                ...
                                <tr class="align-middle invoice-row" onclick="window.location.href='<?php echo e(route('invoices.show', $invoice->id)); ?>'" style="cursor: pointer;" data-status="<?php echo e($invoice->payment_status); ?>">
                                    ...
                                    <td>
                                        ...
                                        <div class="amount-info text-center mb-2">
                                            <h6 class="amount mb-1"><?php echo e(number_format($invoice->grand_total ?? $invoice->total, 2)); ?> <small class="currency"><?php echo $currencySymbol; ?></small></h6>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtrasmart\fawtrasmart\resources\views/sales/invoices/index.blade.php ENDPATH**/ ?>