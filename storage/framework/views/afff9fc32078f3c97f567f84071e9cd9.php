    ...
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item <?php echo e(request()->is("$getLocal/dashboard/*") ? 'active open' : ''); ?>">
                <a href="index.html"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard"><?php echo e(trans('main_trans.Dashboards')); ?></span><span class="badge badge badge-warning badge-pill float-right mr-2">2</span></a>
...
<?php if(isset($settings['sales']) && $settings['sales'] === 'active'): ?>
                <li class="nav-item <?php echo e(request()->is("$getLocal/sales/*") ? 'active open' : ''); ?>">
                    ...
                    <ul class="menu-content">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sales_edit_payment_options')): ?>
                            <li><a href="<?php echo e(route('SittingInvoice.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                ...
                <ul class="menu-content">
                    <li>
                        <a href="<?php echo e(route('POS.sales_start.index')); ?>">
                            ...
                            <span class="menu-item" data-i18n="Start Sale"><?php echo e(trans('main_trans.Start_Sale')); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('pos.sessions.index')); ?>">
                            <i class="feather icon-circle"></i>
                            <span class="menu-item" data-i18n="Sessions"><?php echo e(trans('main_trans.Sessions')); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('pos_reports.index')); ?>">
                            <i class="feather icon-circle"></i>
                            <span class="menu-item" data-i18n="POS Reports"><?php echo e(trans('main_trans.POS_Reports')); ?></span>
                        </a>
                    </li>
                    <li>
            ...
            <?php if(isset($settings['ecommerce']) && $settings['ecommerce'] === 'active'): ?>
                <li class=" nav-item <?php echo e(request()->is("$getLocal/online_store/*") ? 'active open' : ''); ?>"><a href="index.html">
                        <i class="feather icon-shopping-cart">
                        </i><span class="menu-title" data-i18n="Dashboard"><?php echo e(trans('main_trans.Online_store')); ?></span>
                    </a>
                    <ul class="menu-content">
                        <li><a href="<?php echo e(route('content_management.index')); ?>"><i class="feather icon-circle <?php echo e(request()->is("$getLocal/online_store/content-management/*") ? 'active' : ''); ?>"></i><span class="menu-item"
                                    data-i18n="Analytics"><?php echo e(trans('main_trans.Content_management')); ?></span></a>
                        </li>
                        <li><a href="<?php echo e(route('store_settings.index')); ?>"><i class="feather icon-circle <?php echo e(request()->is("$getLocal/online_store/store_settings/*") ? 'active' : ''); ?>"></i><span class="menu-item"
                                    data-i18n="eCommerce"><?php echo e(trans('main_trans.Settings')); ?></span></a>
                        </li>
                    </ul>
                </li>
                <?php endif; ?>
                    ...
                    <ul class="menu-content">
                        <li>
                            <a href="<?php echo e(route('BOM.index')); ?>">
                                <i class="feather icon-circle <?php echo e(request()->is("$getLocal/Manufacturing/BOM/*") ? 'active' : ''); ?>"></i> <span class="menu-item" data-i18n="Analytics"><?php echo e(trans('main_trans.Bill_of_Materials')); ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('manufacturing.orders.index')); ?>">
                                <i class="feather icon-circle <?php echo e(request()->is("$getLocal/Manufacturing/Orders/*") ? 'active' : ''); ?>"></i>
                                <span class="menu-item"
                        ...
                        <li>
                            <a href="<?php echo e(route('manufacturing.indirectcosts.index')); ?>">
                                <i class="feather icon-circle <?php echo e(request()->is("$getLocal/Manufacturing/indirectcosts/*") ? 'active' : ''); ?>"></i>
                                <span class="menu-item"
                        ...
                        <li>
                            <a href="<?php echo e(route('manufacturing.workstations.index')); ?>">
                                <i class="feather icon-circle <?php echo e(request()->is("$getLocal/Manufacturing/Workstations/*") ? 'active' : ''); ?>"></i>
                                <span class="menu-item" data-i18n="Analytics"><?php echo e(trans('main_trans.Workstations')); ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('Manufacturing.settings.index')); ?>">
                                <i class="feather icon-circle <?php echo e(request()->is("$getLocal/Manufacturing/Settings/*") ? 'active' : ''); ?>"></i>
                                <span class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Settings')); ?></span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <?php if(
                ...
                <li class="nav-item"><a href="#">
                        ...
                        <span class="menu-title" data-i18n="Dashboard"><?php echo e(trans('main_trans.Reservations')); ?></span>
                    </a>
                    <ul class="menu-content">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rental_unit_manage_rental_settings')): ?>
                            <li><a href="<?php echo e(route('Reservations.Booking_Settings')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item"
                ...
                <li class="nav-item"><a href="index.html">
                    ...
                    <ul class="menu-content">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('targeted_sales_commissions_manage_commission_rules')): ?>
                            <li><a href="<?php echo e(route('CommissionRules.index')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('targeted_sales_commissions_view_all_sales_commissions')): ?>
                            <li><a href="<?php echo e(route('SalesCommission.index')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item"
            ...
            <?php if(
                ...
                <li class="nav-item"><a href="index.html">
                    ...
                    <ul class="menu-content">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rental_unit_view_booking_orders')): ?>
                            <li><a href="<?php echo e(route('rental_management.units.index')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="Analytics"><?php echo e(trans('main_trans.Units')); ?></span></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rental_unit_manage_booking_orders')): ?>
                            <li><a href="<?php echo e(route('rental_management.orders.index')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item"
            ...
            <?php if(isset($settings['work_orders']) && $settings['work_orders'] === 'active'): ?>
                <li class="nav-item"><a href="<?php echo e(route('SupplyOrders.index')); ?>">
                        ...
                        <span class="menu-title" data-i18n="Dashboard"><?php echo e(trans('main_trans.Supply_orders')); ?></span>
                    </a>
                    <ul class="menu-content">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('supply_orders_add')): ?>
                            <li><a href="<?php echo e(route('SupplyOrders.create')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item"
                                        data-i18n="eCommerce"><?php echo e(trans('main_trans.Add_a_job_order')); ?></span></a>
                            </li>
                        <?php endif; ?>

                        <li><a href="<?php echo e(route('SupplySittings.index')); ?>"><i class="feather icon-circle"></i><span
                                    class="menu-item"
           ...
           <?php if(
            ...
            <li class="nav-item"><a href="">
                    ...
                    <span class="menu-title" data-i18n="Dashboard"><?php echo e(trans('main_trans.Business_cycles')); ?></span>
                </a>
                <ul class="menu-content">
                    <li><a href=""><i class="feather icon-circle"></i><span class="menu-item"
                                data-i18n="Analytics"><?php echo e(trans('main_trans.Settings')); ?></span></a></li>
                </ul>
            </li>
           <?php endif; ?>
            <?php endif; ?>
            ...
            <?php if(
                ...
                <li class="nav-item">
                    <a href="#">
                        ...
                        <span class="menu-title" data-i18n="Dashboard"><?php echo e(trans('main_trans.Customers')); ?></span>
                    </a>
                    <ul class="menu-content">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('client_follow_up_add_notes_attachments_appointments_all')): ?>
                            <li><a href="<?php echo e(route('appointments.index')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Appointments')); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>

                        <li><a href="<?php echo e(route('clients.contacts')); ?>"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Contact_list')); ?></span>
                            </a>
                        </li>

                        <li><a href="<?php echo e(route('clients.mang_client')); ?>"><i class="feather icon-circle"></i><span
                                    class="menu-item"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('clients_edit_client_settings')): ?>
                            <li><a href="<?php echo e(route('clients.setting')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
            ...
            <?php if(
                ...
                <li class="nav-item">
                    <a href="#">
                        ...
                        <span class="menu-title" data-i18n="Dashboard"><?php echo e(trans('main_trans.Points_and_credits')); ?></span>
                    </a>
                    <ul class="menu-content">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('points_credits_credit_recharge_manage')): ?>
                            <li><a href="<?php echo e(route('MangRechargeBalances.index')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('points_credits_credit_usage_manage')): ?>
                            <li><a href="<?php echo e(route('ManagingBalanceConsumption.index')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('points_credits_packages_manage')): ?>
                            <li><a href="<?php echo e(route('PackageManagement.index')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('points_credits_credit_settings_manage')): ?>
                            <li><a href="<?php echo e(route('sitting.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                        data-i18n="eCommerce"><?php echo e(trans('main_trans.Settings')); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
            ...
            <?php if(
                ...
                <li class="nav-item">
                    <a href="#">
                        ...
                        <span class="menu-title" data-i18n="Dashboard"><?php echo e(trans('main_trans.Loyalty_points')); ?></span>
                    </a>
                    <ul class="menu-content">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customer_loyalty_points_managing_customer_bases')): ?>
                            <li><a href="<?php echo e(route('loyalty_points.index')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customer_loyalty_points_redeem_loyalty_points')): ?>
                            <li><a href="<?php echo e(route('sittingLoyalty.sitting')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Settings')); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('membership_setting_management')): ?>
                            <li>
                                <a href="<?php echo e(route('SittingMemberships.index')); ?>">
                                    <i class="feather icon-circle"></i>
                                    <span class="menu-item" data-i18n="eCommerce">
                                        <?php echo e(trans('main_trans.Settings')); ?>
        ...
        <?php endif; ?>
            ...
            <?php if(isset($settings['customer_attendance']) && $settings['customer_attendance'] === 'active'): ?>
                <li class=" nav-item"><a href="index.html">
                    ...
                    <ul class="menu-content">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customer_attendance_display')): ?>
                            <li><a href="<?php echo e(route('customer_attendance.index')); ?>"><i class="feather icon-circle"></i><span
                                        class="menu-item"
           ...
           <li class=" nav-item"><a href="index.html">
               ...
               <ul class="menu-content">
                   <li><a href="<?php echo e(route('Insurance_Agents.index')); ?>"><i class="feather icon-circle"></i><span
                               class="menu-item"
                               data-i18n="Analytics"><?php echo e(trans('main_trans.Insurance_Agents_Management')); ?></span></a>
                   </li>

                   <li><a href="<?php echo e(route('Insurance_Agents.create')); ?>"><i class="feather icon-circle"></i><span
                               class="menu-item"
       ...
       <?php endif; ?>
        <?php endif; ?>
            ...
            <?php if(
                ...
                <li class=" nav-item <?php echo e(request()->is("$getLocal/stock/*") ? 'active open' : ''); ?>"><a href="">
                    ...
                    <ul class="menu-content">
                        ...
                        <li><a href="<?php echo e(route('products.traking')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('products_view_price_groups')): ?>
                            <li><a href="<?php echo e(route('price_list.index')); ?>"><i
                                        ...
                                        class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.price_lists')); ?></span></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <li><a href="<?php echo e(route('storehouse.index')); ?>"><i
                                    ...
                                    class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.warehouses')); ?></span></a>
                        </li>
                ...
                <li class=" nav-item"><a href="index.html">
                    ...
                    <ul class="menu-content">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchase_cycle_orders_manage_orders')): ?>
                            ...
                            <li><a href="<?php echo e(route('OrdersPurchases.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                        data-i18n="Analytics"> <?php echo e(trans('main_trans.Purchase_Orders')); ?></span></a>
                            </li>
                        <?php endif; ?>

                        <li><a href="<?php echo e(route('Quotations.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                        ...
                        <li><a href="<?php echo e(route('pricesPurchase.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="eCommerce"> <?php echo e(trans('main_trans.Purchase_Quotations')); ?></span></a>
                        </li>
                        <li><a href="<?php echo e(route('OrdersRequests.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="eCommerce">أوامر الشراء</span></a>
                        </li>
                        <li><a href="<?php echo e(route('invoicePurchases.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="eCommerce"><?php echo e(trans('main_trans.Purchase_Invoices')); ?>

                                </span></a>
                        </li>
                        <li><a href="<?php echo e(route('ReturnsInvoice.index')); ?>"><i class="feather icon-circle"></i><span
                                    class="menu-item"
                        ...
                        <li><a href="<?php echo e(route('SupplierManagement.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
            ...
            <?php if(isset($settings['time_tracking']) && $settings['time_tracking'] === 'active'): ?>
                <li class=" nav-item"><a href="index.html">
                    ...
                    <ul class="menu-content">
                        ...
                        <li><a href="<?php echo e(route('TrackTime.create_invoice_time')); ?>"><i class="feather icon-circle"></i><span
                                    class="menu-item"
                                    data-i18n="Analytics"><?php echo e(trans('main_trans.Create_Invoice')); ?></span></a>
                        </li>

                        <li><a href="<?php echo e(route('SittingTrackTime.index')); ?>"><i class="feather icon-circle"></i><span
                                    class="menu-item"
                ...
                <?php if(isset($settings['finance']) && $settings['finance'] === 'active'): ?>
                            <li class=" nav-item <?php echo e(request()->is("$getLocal/finance/*") ? 'active open' : ''); ?>">
                                <a href="index.html">
                                    ...
                                    </i><span class="menu-title" data-i18n="Dashboard"><?php echo e(trans('main_trans.Financial')); ?></span>
                                </a>
                                ...
                                <ul class="menu-content">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('finance_view_all_expenses')): ?>
                                        <li><a href="<?php echo e(route('expenses.index')); ?>"><i
                                                    ...
                                                    class="menu-item" data-i18n="Analytics"><?php echo e(trans('main_trans.Expenses')); ?></span></a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('finance_view_all_receipts')): ?>
                                        <li><a href="<?php echo e(route('incomes.index')); ?>"><i
                                                    ...
                                                    class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Receipts')); ?></span></a>
                                        </li>
                                    <?php endif; ?>
            ...
            <?php if(
                  ...
                  <?php if(isset($settings['general_accounts_journal_entries']) && $settings['general_accounts_journal_entries'] === 'active'): ?>
                            <li class=" nav-item <?php echo e(request()->is("$getLocal/Accounts/*") ? 'active open' : ''); ?>"><a href="index.html">
                                ...
                                <ul class="menu-content">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('g_a_d_r_add_edit_delete_all_journal_entries')): ?>
                                        <li><a href="<?php echo e(route('journal.create')); ?>"><i class="feather icon-circle"></i><span
                                                    class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Add_Entry')); ?></span></a>
                                        </li>
                                    <?php endif; ?>

                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('g_a_d_r_manage_journal_entries')): ?>
                                        <li><a href="<?php echo e(route('accounts_chart.index')); ?>"><i class="feather icon-circle <?php echo e(request()->is("$getLocal/Accounts/accounts_chart/*") ? 'active' : ''); ?>"></i><span
                                                    class="menu-item" data-i18n="eCommerce">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('g_a_d_r_view_cost_centers')): ?>
                                        <li><a href="<?php echo e(route('cost_centers.index')); ?>"><i class="feather icon-circle <?php echo e(request()->is("$getLocal/Accounts/cost_centers/*") ? 'active' : ''); ?>"></i><span
                                                    class="menu-item"
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('g_a_d_r_add_new_assets')): ?>
                                        <li><a href="<?php echo e(route('Assets.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                                    data-i18n="eCommerce">
                                                    <?php echo e(trans('main_trans.Assets')); ?></span></a>
                                        </li>
                                    <?php endif; ?>

                                    <li><a href="<?php echo e(route('accounts_settings.index')); ?>"><i class="feather icon-circle"></i><span
                                                class="menu-item"
            ...
            <?php if(isset($settings['cheque_cycle']) && $settings['cheque_cycle'] === 'active'): ?>
                <li class=" nav-item <?php echo e(request()->is("$getLocal/cheques*") ? 'active open' : ''); ?>"><a href="index.html">
                        <i class="feather icon-dollar-sign">
                        </i><span class="menu-title" data-i18n="Dashboard">
                ...
                <li class=" nav-item"><a href="index.html">
                    ...
                    <ul class="menu-content">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orders_management')): ?>
                            <li><a href="<?php echo e(route('orders.management.mangame')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orders_setting_management')): ?>
                            <li><a href="<?php echo e(route('orders.Settings.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                        data-i18n="eCommerce"><?php echo e(trans('main_trans.Settings')); ?></span></a>
                            </li>
                        <?php endif; ?>
                    </ul>
            ...
            <?php if(isset($settings['organizational_structure']) && $settings['organizational_structure'] === 'active'): ?>
                <li class=" nav-item <?php echo e(request()->is("$getLocal/OrganizationalStructure/*") ? 'active open' : ''); ?>">
                    <a href="index.html">
                                ...
                                <ul class="menu-content">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('staff_attendance_settings_manage')): ?>
                                        <li><a href="<?php echo e(route('attendance.settings.index')); ?>"><i
                                                    ...
                                                    class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Settings')); ?></span></a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                                ...
                                <ul class="menu-content">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('salaries_contracts_view_all')): ?>
                                        <li><a href="<?php echo e(route('Contracts.index')); ?>"><i class="feather icon-circle"></i><span
                                                    class="menu-item" data-i18n="Analytics"><?php echo e(trans('main_trans.Contracts')); ?></span></a>
                                        </li>
                                    <?php endif; ?>

                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('salaries_payroll_view')): ?>
                                        <li><a href="<?php echo e(route('PayrollProcess.index')); ?>"><i class="feather icon-circle"></i><span
                                                    class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Payroll')); ?></span></a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('salaries_loans_manage')): ?>
                                        <li><a href="<?php echo e(route('ancestor.index')); ?>"><i class="feather icon-circle"></i><span
                                                    class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Advances')); ?></span></a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <li><a href="<?php echo e(route('SalaryTemplates.index')); ?>"><i class="feather icon-circle"></i><span
                                                class="menu-item"
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('salaries_payroll_settings_manage')): ?>
                                        <li><a href="<?php echo e(route('SalarySittings.index')); ?>"><i class="feather icon-circle"></i><span
                                                    class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Settings')); ?></span></a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
            ...
            <li class=" nav-item"><a href="index.html">
                ...
                <ul class="menu-content">
                    ...
                    <li><a href="<?php echo e(route('GeneralAccountReports.index')); ?>"><i class="feather icon-circle"></i><span
                                class="menu-item"
                    ...
                    <li><a href=""><i class="feather icon-circle"></i><span
                                class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.SMS_Report')); ?></span></a>
                    </li>
            ...
            <li class=" nav-item"><a href="index.html">
                ...
                <ul class="menu-content">
                    ...
                    <li><a href="<?php echo e(route('branches.create')); ?>"><i class="feather icon-circle"></i><span
                                class="menu-item" data-i18n="eCommerce"><?php echo e(trans('main_trans.Add_Branch')); ?></span></a>
                    </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('settings_edit_general_settings')): ?>
                <li class=" nav-item"><a href="index.html">
                        <i class="feather icon-settings">
                            ...
                            <?php echo e(trans('main_trans.Settings')); ?></span>
                    </a>
                    <ul class="menu-content">
                        ...
                        <li><a href="<?php echo e(route('SMPT.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                        ...
                        <li><a href="<?php echo e(route('Sms.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="eCommerce"><?php echo e(trans('main_trans.SMS_Settings')); ?></span></a></li>

                        <li><a href="<?php echo e(route('SequenceNumbering.index', 'section')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="eCommerce"><?php echo e(trans('main_trans.Sequential_Numbering_Settings')); ?></span></a>
                        </li>
                        <li><a href="<?php echo e(route('TaxSitting.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="eCommerce"><?php echo e(trans('main_trans.Tax_Settings')); ?></span></a>
                        </li>
                        <li><a href="<?php echo e(route('Application.index')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
                                    data-i18n="eCommerce"><?php echo e(trans('main_trans.Applications_Management')); ?></span></a>
                        </li>

                        <li><a href="<?php echo e(route('AccountInfo.backgroundColor')); ?>"><i class="feather icon-circle"></i><span class="menu-item"
...
<?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>