                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">اضافة خزينة
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="content-body">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form id="products_form" class="form form-vertical" action="<?php echo e(route('treasury.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="basicSelect" name="is_active">
                                            <option value="0" <?php echo e(old('is_active') == 0 ? 'selected' : ''); ?>>نشط</option>
                                            <option value="1" <?php echo e(old('is_active') == 1 ? 'selected' : ''); ?>>غير نشط</option>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtramsmart\fawtra\resources\views/finance/treasury/carate.blade.php ENDPATH**/ ?>