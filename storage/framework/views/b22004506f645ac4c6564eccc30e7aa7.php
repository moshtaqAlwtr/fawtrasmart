...
<body>
    ...
    <div class="header">
        <h1>فاتورة مرتجع</h1>
        <p>رقم: <?php echo e(str_pad($return_invoice->id, 5, '0', STR_PAD_LEFT)); ?></p>
        <p>التاريخ: <?php echo e($return_invoice->created_at->format('Y/m/d')); ?></p>
    </div>
    ...
    <table class="info-grid" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="info-value" colspan="3"><?php echo e($return_invoice->client->trade_name ?? $return_invoice->client->first_name . ' ' . $return_invoice->client->last_name); ?></td>
        </tr>
        <tr>
            <td class="info-label">الهاتف:</td>
            <td class="info-value"><?php echo e($return_invoice->client->mobile ?? 'غير متوفر'); ?></td>
            <td class="info-label">الفاتورة الأصلية:</td>
            <td class="info-value"><?php echo e($return_invoice->code ?? ""); ?></td>
        </tr>
        <tr>
            <td class="info-label">الرقم الضريبي:</td>
            <td class="info-value" colspan="3"><?php echo e($return_invoice->client->tax_number ?? 'غير متوفر'); ?></td>
        </tr>
    </table>
...
?>
    ...
    <div class="totals">
        ...
        <p><strong>إجمالي المرتجع:</strong> <?php echo e(number_format($return_invoice->grand_total ?? 0, 2)); ?> <?php echo $currencySymbol; ?></p>
    </div>
...
</html><?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/sales/retend_invoice/pdf.blade.php ENDPATH**/ ?>