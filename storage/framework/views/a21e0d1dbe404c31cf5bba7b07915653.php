...
<div class="card-body">
    ...
    <div class="card p-3 mb-4">
        <form method="GET" action="<?php echo e(route('statistics.group')); ?>" id="dateFilterForm">
            <div class="row g-3">
                <div class="col-md-4 col-12">
...
<div class="card">
    <div class="card-body">
        ...
        <?php if($branchesPerformance->count()): ?>
        <div class="table-responsive">
            <table id="clientsTable1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $branchesPerformance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($branch->branch_name ?? 'غير معروف'); ?></td>
                            <td><?php echo e(number_format($branch->payments)); ?> ريال</td>
                            <td><?php echo e(number_format($branch->receipts)); ?> ريال</td>
                            <td><?php echo e(number_format($branch->total_collected)); ?> ريال</td>
                            <td>
                                <?php
                                    $percentage = $grandTotal > 0 
                                        ...
                                        : 0;
                                ?>
                                <span class="badge bg-<?php echo e($percentage >= 60 ? 'success' : ($percentage >= 30 ? 'warning' : 'danger')); ?>">
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtramsmart\fawtra\resources\views/Statistics/Branches.blade.php ENDPATH**/ ?>