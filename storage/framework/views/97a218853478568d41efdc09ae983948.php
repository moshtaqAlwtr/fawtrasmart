...
<div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div>
                        <a href="<?php echo e(route('journal.index')); ?>" class="btn btn-outline-danger">
...
<div class="container mt-5">
    <form action="<?php echo e(route('journal.store')); ?>" method="POST" enctype="multipart/form-data" id="journal_form">
        <?php echo csrf_field(); ?>
        <?php if($errors->any()): ?>
                    ...
                    <table class="table" id="entries-table">
                        ...
                        <tbody>
                            <tr>
                              ...
                              <ul>
                                         <?php $__currentLoopData = $accountPath; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <li><?php echo e($parent->name); ?></li>
                                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                               </ul>
                                             <?php endif; ?>
                                             ...
                                             <select name="details[0][account_id]" class="form-control account-search" required>
                                                ...
                                                <?php $__currentLoopData = $sortedAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($account->id); ?>">
                                                    <?php
                                                        $indentation = str_repeat('—', $account->level);  // حساب المسافة البادئة بناءً على المستوى
                                                    ?>
                                                    <?php echo e($indentation); ?> <?php echo e($account->name); ?> (<?php echo e($account->code); ?>)
                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                ...
                                <td>
                                    <select name="details[0][cost_center_id]" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $costCenters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $center): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/Accounts/journal/create.blade.php ENDPATH**/ ?>