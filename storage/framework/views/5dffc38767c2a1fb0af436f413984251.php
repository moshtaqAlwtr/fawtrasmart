...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <form id="products_form" class="form-horizontal" action="<?php echo e(route('store_permits_management.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="form-body row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" name="from_store_houses_id" id="from_store_houses_id">
                                        <?php $__currentLoopData = $storeHouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $storeHouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($storeHouse->id); ?>" <?php echo e(old('store_houses_id') == $storeHouse->id ? 'selected' : ''); ?>><?php echo e($storeHouse->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="basicSelect" name="sub_account">
                                        <option value="1" <?php echo e(old('sub_account') == 0 ? 'selected' : ''); ?>>الحساب الفرعي 1</option>
                                        <option value="2" <?php echo e(old('sub_account') == 1 ? 'selected' : ''); ?>>الحساب الفرعي 2</option>
                                    </select>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>رقم <span style="color: red">*</span></label>
                                    <input type="number" class="form-control" name="number" value="<?php echo e($serial_number); ?>">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="feedback2">الملاحظات </label>
                                    <textarea class="form-control" rows="2" placeholder="ادخل ملاحظاتك هنا" name="details"><?php echo e(old('details')); ?></textarea>
                                </div>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtramsmart\fawtra\resources\views/stock/store_permits_management/manual_conversion.blade.php ENDPATH**/ ?>