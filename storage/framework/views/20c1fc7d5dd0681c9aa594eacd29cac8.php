...
<?php $__env->startSection('content'); ?>
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">انشاء فاتورة دورية </h2>
    ...
    <div class="content-body">
        <form id="" action="<?php echo e(route('periodic_invoices.store')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <?php if($errors->any()): ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control form-control-lg shadow-sm"
                                            name="first_invoice_date" value="<?php echo e(date('Y-m-d')); ?>"
                                            style="border-radius: 10px; border: 1px solid #e2e8f0; padding: 12px;">
                                    </div>
                                </div>
                                        ...
                                        <select class="form-control form-control-lg shadow-sm select2" id="clientSelect"
                                            ...
                                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($client->id); ?>">
                                                    <?php echo e($client->trade_name ?: $client->first_name . ' ' . $client->last_name); ?>
                            ...
                            <table class="table" id="items-table">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td><span id="total-tax">0.00</span> <?php echo $currencySymbol; ?></td>
                                        <td></td>
                                    </tr>
                                    <tr>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/sales/periodic_invoices/create.blade.php ENDPATH**/ ?>