...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
        <form id="invoice-form" action="<?php echo e(route('questions.store')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <?php if($errors->any()): ?>
                                ...
                                <div class="row add_item">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <label class="form-control"> <?php echo e($quotes_number); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="date" name="quote_date" value="<?php echo e(old('quote_date', date('Y-m-d'))); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
    ...
    <div class="input-group">
        ...
        <input type="hidden" name="items[0][tax_2_id]">
                               ...
                               <tfoot id="tax-rows">
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-right">مجموع الخصومات</td><?php echo $currencySymbol; ?>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtramsmart\fawtra\resources\views/sales/qoution/create.blade.php ENDPATH**/ ?>