<nav class="header-navbar navbar-expand-lg navbar navbar-with-menu floating-nav navbar-light navbar-shadow">
            ...
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <ul class="nav navbar-nav bookmark-icons">
                        ...
                        <li class="nav-item d-none d-lg-block"><a class="nav-link" href="<?php echo e(route('task.index')); ?>" data-toggle="tooltip" data-placement="top" title="Todo"><i class="ficon feather icon-check-square"></i></a></li>
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-language nav-item">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            ...
                            <a class="dropdown-item" hreflang="<?php echo e($localeCode); ?>" href="<?php echo e(LaravelLocalization::getLocalizedURL($localeCode, null, [], true)); ?>" data-language="<?php echo e($localeCode); ?>">
                                <?php if($localeCode == 'ar'): ?>
                                    <i class="flag-icon flag-icon-sa"></i> <?php echo e($properties['native']); ?> <!-- علم السعودية -->
                                <?php elseif($localeCode == 'ur'): ?>
                                    <i class="flag-icon flag-icon-pk"></i> <?php echo e($properties['native']); ?> <!-- علم باكستان -->
                                <?php elseif($localeCode == 'hi'): ?>
                                    <i class="flag-icon flag-icon-in"></i> <?php echo e($properties['native']); ?> <!-- علم الهند -->
                                <?php elseif($localeCode == 'bn'): ?>
                                    <i class="flag-icon flag-icon-bd"></i> <?php echo e($properties['native']); ?> <!-- علم بنغلاديش -->
                                <?php else: ?>
                                    <i class="flag-icon flag-icon-us"></i> <?php echo e($properties['native']); ?> <!-- علم الولايات المتحدة -->
                                <?php endif; ?>
                            </a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="dropdown-menu-footer">
                                <a class="dropdown-item p-1 text-center" href="<?php echo e(route('notifications.index')); ?>">عرض كل الإشعارات</a>
                            </li>
                        </ul>
                    </li>
    ...
    function fetchNotifications() {
        $.ajax({
            url: "<?php echo e(route('notifications.unread')); ?>", // جلب الإشعارات
            method: "GET",
    ...
    $(document).on('click', '.notification-item', function () {
        ...
        $.ajax({
            url: "<?php echo e(route('notifications.markAsRead')); ?>", // استدعاء API التحديث
            method: "POST",
            data: {
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
            <div class="d-flex align-items-center">
                ...
                <div class="search-data">
                    <p class="search-data-title mb-0"><?php echo e(auth()->user()->name); ?></p><small class="text-muted">UI designer</small>
                </div>
            </div>
        </a></li>
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
