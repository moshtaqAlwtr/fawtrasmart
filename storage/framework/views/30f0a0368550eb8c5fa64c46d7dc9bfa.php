        ...
        <div class="receipt-container">
            <div class="receipt">
                ...
                <div class="invoice-to">
                    ...
                    <h1 class="mb-0"> <?php echo e($invoice->client->code ?? 'غير متوفر'); ?></h1>
                ...
                <div class="invoice-details">
                    ...
                    <div class="summary-row">
                        ...
                        <span><?php echo e($invoice->invoice_date??'غير متوفر'); ?></span>
                ...
                <div class="invoice-summary">
                    ...
                    <?php if($invoice->advance_payment > 0): ?>
                        <div class="summary-row" id="advance-payment-row">
                            ...
                            <span id="advance-payment-amount"><?php echo e(number_format($invoice->advance_payment, 2)); ?>
                    ...
                    <?php if($returnedInvoice): ?>
                        <div class="summary-row">
                            <span> مرتجع:</span>
                            <span> <?php echo e(number_format($invoice->returned_payment, 2) ?? ''); ?>
                    ...
                    <div class="summary-row">
                        ...
                        <span id="due-value-amount"><?php echo e(number_format($invoice->due_value, 2)); ?> ر.س</span>
                    </div>
