...
<body style="direction: rtl; text-align: right; font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
    ...
    <table align="center" width="600" style="background: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
        <tr>
            <td>
                <h2 style="color: #333;">مرحبًا <?php echo e($details['name']); ?></h2>
                <p style="font-size: 16px; color: #555; line-height: 1.8;">تم إنشاء حساب لك بنجاح. إليك تفاصيل تسجيل الدخول:</p>

                <p style="background: #f8f9fa; padding: 10px; border-radius: 5px; font-size: 18px;"><strong>البريد الإلكتروني:</strong> <?php echo e($details['email']); ?></p>
                <p style="background: #f8f9fa; padding: 10px; border-radius: 5px; font-size: 18px;"><strong>كلمة المرور:</strong> <?php echo e($details['password']); ?></p>
...
<?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/emails/login_credentials.blade.php ENDPATH**/ ?>