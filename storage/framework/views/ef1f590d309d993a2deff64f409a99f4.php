...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="<?php echo e(route('CityNotices.create')); ?>" class="btn btn-success">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form" id="searchForm" method="GET" action="<?php echo e(route('CityNotices.index')); ?>">
                    <div class="row g-3">
                        <!-- الحقول الأساسية -->
                        <div class="col-md-4">
            ...
            <div class="card-body">
                <?php if($cityNotices->count() > 0): ?>
                    <table class="table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $cityNotices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <input type="checkbox" class="form-check-input order-checkbox"
                                            value="<?php echo e($notice->id); ?>">
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <?php echo e($notice->code); ?>

                                                <div class="text-muted small">#<?php echo e($notice->id); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td><?php echo e($notice->supplier->trade_name ?? 'غير محدد'); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($notice->date)->format('Y-m-d')); ?></td>
                                    <td>
                                        <?php switch($notice->payment_method):
                                            case (1): ?>
                                     ...
                                     <?php
                                        ...
                                        ?>
                                    <td><?php echo e(number_format($notice->grand_total, 2)); ?> <?php echo $currencySymbol; ?></td>
                                    <td>
                                        <?php if($notice->is_paid): ?>
                                            <span class="badge bg-success">تم التسوية</span>
                                        <?php elseif($notice->advance_payment > 0): ?>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn bg-gradient-info fa fa-ellipsis-v mr-1 mb-1 btn-sm"
                                                    type="button" id="dropdownMenuButton<?php echo e($notice->id); ?>"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                </button>
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    aria-labelledby="dropdownMenuButton<?php echo e($notice->id); ?>">
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('CityNotices.show', $notice->id)); ?>">
                                                        <i class="fa fa-eye me-2 text-primary"></i>عرض
                                                    </a>
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('CityNotices.edit', $notice->id)); ?>">
                                                    ...
                                                    <a class="dropdown-item text-danger" href="#"
                                                        ...
                                                        data-bs-target="#deleteModal<?php echo e($notice->id); ?>">
                                        ...
                                        <!-- Modal delete -->
                                        <div class="modal fade" id="deleteModal<?php echo e($notice->id); ?>" tabindex="-1">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>هل أنت متأكد من حذف الإشعار المدين رقم
                                                            "<?php echo e($notice->code); ?>"؟</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-light"
                                                            data-bs-dismiss="modal">إلغاء</button>
                                                        <form
                                                            action="<?php echo e(route('CityNotices.destroy', $notice->id)); ?>"
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/Purchases/city_notices/index.blade.php ENDPATH**/ ?>