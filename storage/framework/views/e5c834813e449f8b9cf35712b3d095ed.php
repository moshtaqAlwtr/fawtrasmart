...
<body>
    ...
    <div class="invoice-number">فاتورة # <?php echo e($invoice->code ??""); ?>:</div>
    
   <div class="address-section">
    <div class="invoice-to">
        <div style="font-weight: bold;">فاتورة إلى</div>
        <div style="margin-top: 5px;"><?php echo e($invoice->client->trade_name ?? ""); ?></div>
    </div>
    <div class="ship-to">
        <div style="font-weight: bold;">المستودع</div>
        <div style="margin-top: 5px;">الرياض الرياض 11111</div>
    </div>
</div>
...
<?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/sales/invoices/picklist.blade.php ENDPATH**/ ?>