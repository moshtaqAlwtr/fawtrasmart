...
فاتورة الشراء #<?php echo e($purchaseInvoice->code); ?>
    ...
    <div class="content-header d-flex justify-content-between align-items-center mb-2">
        <div>
            <h2 class="content-header-title mb-0">
                ...
                <span class="badge <?php echo e($purchaseInvoice->status == 1 ? 'bg-warning' : 'bg-success'); ?>">
                    <?php echo e($purchaseInvoice->status == 1 ? 'مدفوعة' : 'مستلم'); ?>

                </span>
            </h2>
            <small>المورد: <?php echo e($purchaseInvoice->supplier->name); ?> - Journal #<?php echo e($purchaseInvoice->code); ?></small>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header p-2">
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo e(route('PaymentSupplier.createPurchase',$purchaseInvoice->id )); ?>" type="button" class="btn btn-outline-success btn-sm" onclick="addPayment()">
                                        ...
                                        <div class="card shadow" style="max-width: 600px; margin: 20px auto;">
                                            <div class="card-body bg-white p-4" style="min-height: 400px; overflow: auto;">
                                                <div style="transform: scale(0.8); transform-origin: top center;">
                                                    <?php echo $__env->make('Purchases.Invoices_purchase.pdf', ['purchaseInvoice' => $purchaseInvoice], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>هل أنت متأكد من حذف الفاتورة رقم "<?php echo e($purchaseInvoice->code); ?>"؟</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">إلغاء</button>
                    <form action="<?php echo e(route('invoicePurchases.destroy', $purchaseInvoice->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/Purchases/Invoices_purchase/show.blade.php ENDPATH**/ ?>