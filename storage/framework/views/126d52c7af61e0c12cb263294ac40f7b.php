...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
        ...
        <div class="card">
            <div class="card-body">
                <form id="incomes_form" action="<?php echo e(route('incomes.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                          <?php
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control form-control-lg py-3" id="amount" placeholder="<?php echo $currencySymbol; ?> 0.00" name="">
...
unset($__errorArgs, $__bag); ?>
    ...
    <input type="text" class="form-control form-control-lg py-3" id="total_amount"
        placeholder="<?php echo $currencySymbol; ?> 0.00" name="amount" readonly>
</div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="code-number" name="code" value="<?php echo e($nextCode); ?>" readonly>
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="category" class="form-control" name="incomes_category_id">
                                ...
                                <?php $__currentLoopData = $incomes_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incomes_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($incomes_category->id); ?>" <?php echo e(old('incomes_category_id') == $incomes_category->id ? 'selected' : ''); ?>><?php echo e($incomes_category->name); ?></option>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/finance/incomes/create.blade.php ENDPATH**/ ?>