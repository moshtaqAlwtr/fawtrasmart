...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../app-assets/css-rtl/pages/error.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    ...
                                    <h1 class="font-large-2 my-1">خطأ 403 !</h1>
                                    <p class="p-2">
                                        المستخدم ليس لديه الأذونات الصحيحة.
                                    </p>
                                    <a class="btn btn-primary btn-lg mt-2" href="<?php echo e(route('dashboard_sales.index')); ?>">العودة للرئيسية</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\fawtrasmart\fawtrasmart\resources\views/errors/403.blade.php ENDPATH**/ ?>