            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="card hover-card">
                        <div class="card-content">
                            <div class="card-body setting">
                                <a href="<?php echo e(route('visits.traffics')); ?>">
                                    <img class="p-3" src="<?php echo e(asset('app-assets/images/icons8-pager-100.png')); ?>" alt="img placeholder">
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtrasmart\fawtrasmart\resources\views/client/setting/index.blade.php ENDPATH**/ ?>