...
<div class="content-body">
    <form id="permissions_form" action="<?php echo e(route('managing_employee_roles.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
    <div class="card">
        <div class="card-body">
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtrasmart\fawtrasmart\resources\views/hr/managing_employee_roles/create.blade.php ENDPATH**/ ?>