...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
        <div class="container-fluid">
            <form class="form-horizontal" action="<?php echo e(route('Offers.update', $offers->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="form-body row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" id="feedback2" class="form-control" placeholder="الاسم"
                                        name="name" value="<?php echo e(old('name', $offers->name)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" name="valid_from" id="" class="form-control"
                                        value="<?php echo e(old('valid_from', $offers->valid_from)); ?>">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" name="valid_to" class="form-control" id=""
                                        value="<?php echo e(old('valid_to', $offers->valid_to)); ?>">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="type">
                                        <option value="1" <?php echo e(old('type', $offers->type) == 1 ? 'selected' : ''); ?>>اختر البند</option>
                                        <option value="2" <?php echo e(old('type', $offers->type) == 2 ? 'selected' : ''); ?>>اشتري كمية واحصل خصم على البند</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="quantity" class="form-control" id="quantity"
                                        value="<?php echo e(old('quantity', $offers->quantity)); ?>">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="discount_type">
                                        <option value="1" <?php echo e(old('discount_type', $offers->discount_type) == 1 ? 'selected' : ''); ?>>خصم حقيقي</option>
                                        <option value="2" <?php echo e(old('discount_type', $offers->discount_type) == 2 ? 'selected' : ''); ?>>خصم نسبي</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="discount_value" class="form-control" id=""
                                        value="<?php echo e(old('discount_value', $offers->discount_value)); ?>">
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input list="classifications" class="form-control" id="client_type" name="category"
                                            placeholder="اكتب التصنيف" value="<?php echo e(old('category', $offers->category)); ?>">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="client_id">
                                        ...
                                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($client->id); ?>" <?php echo e(old('client_id', $offers->client_id) == $client->id ? 'selected' : ''); ?>>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="is_active" value="1"
                                            <?php echo e(old('is_active', $offers->is_active) == 1 ? 'checked' : ''); ?> style="width: 3rem; height: 1.5rem;">
                            ...
                            <div class="form-body row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="unit_type">
                                        <option value="1" <?php echo e(old('unit_type', $offers->unit_type) == 1 ? 'selected' : ''); ?>>الكل</option>
                                        <option value="2" <?php echo e(old('unit_type', $offers->unit_type) == 2 ? 'selected' : ''); ?>>التصنيف</option>
                                        <option value="3" <?php echo e(old('unit_type', $offers->unit_type) == 3 ? 'selected' : ''); ?>>المنتجات</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="product_id">
                                        ...
                                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($prod->id); ?>" <?php echo e(old('product_id', $offers->product_id) == $prod->id ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="category_id">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cat->id); ?>" <?php echo e(old('category_id', $offers->category_id) == $cat->id ? 'selected' : ''); ?>>
                                                <?php echo e($cat->name); ?>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/sales/sitting/offers/edit.blade.php ENDPATH**/ ?>