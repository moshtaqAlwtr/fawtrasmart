                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control form-control-lg py-3" id="amount"
                                placeholder="<?php echo e($currencySymbol); ?> 0.00" name="amount">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="code-number" name="code"
                                value="<?php echo e($nextCode); ?>" readonly>
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <select id="category" class="form-control" name="incomes_category_id">
                                ...
                                <?php $__currentLoopData = $incomes_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incomes_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($incomes_category->id); ?>"
                                        <?php echo e(old('incomes_category_id') == $incomes_category->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtramsmart\fawtra\resources\views/finance/incomes/create.blade.php ENDPATH**/ ?>