...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
        <form id="clientForm" action="<?php echo e(route('Assets.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php if($errors->any()): ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div>
                            <a href="<?php echo e(route('Assets.index')); ?>" class="btn btn-outline-danger">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="date" name="date_price" id="date_price" class="form-control"
                                                    value="<?php echo e(old('date_price')); ?>">
                                                <div class="form-control-position">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="date" name="date_service" id="date_service"
                                                    class="form-control" value="<?php echo e(old('date_service')); ?>">
                                                <div class="form-control-position">
                                                    <i class="feather icon-calendar"></i>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <select name="place" class="form-control select2" id=""
                                                    style="width: 100%">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="number" name="region_age" id="region_age"
                                                    class="form-control" value="<?php echo e(old('region_age')); ?>">
                                                <div class="form-control-position">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control" id="notes" name="description" rows="5" style="resize: none;"><?php echo e(old('description')); ?></textarea>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative has-icon-left">
                                                <input type="number" step="0.01" id="purchase_value"
                                                    ...
                                                    value="<?php echo e(old('purchase_value')); ?>">
                                                <div class="form-control-position">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <input type="number" step="0.01" class="form-control"
                                                    name="salvage_value" value="<?php echo e(old('salvage_value')); ?>">
                                                <div class="form-control-position">
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehohoqm/hitstest.sehoool.com/resources/views/Accounts/asol/create.blade.php ENDPATH**/ ?>