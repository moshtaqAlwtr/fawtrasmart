                        ...
                        <div class="tab-pane fade" id="signature-tab" role="tabpanel" aria-labelledby="signature-tab">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <h5>سجل التواقيع</h5>
                                        <?php if($invoice->signatures->count() > 0): ?>
                                                ...
                                                <div class="card mb-2">
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-between">
                                                            <div>
                                                                <strong>الاسم:</strong> <?php echo e($signature->signer_name); ?>

                                                                <?php if($signature->signer_role): ?>
                                                                    | <strong>الصفة:</strong> <?php echo e($signature->signer_role); ?>

                                                                <?php endif; ?>
                                                                <?php if($signature->amount_paid): ?>
                                                                    | <strong>المبلغ المدفوع:</strong>
                                                                    <?php echo e(number_format($signature->amount_paid, 2)); ?> ر.س
                                                                <?php endif; ?>
                                                            </div>
                                                            <small><?php echo e($signature->created_at->format('Y-m-d H:i')); ?></small>
                                                        </div>
