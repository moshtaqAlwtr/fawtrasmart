                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination pagination-sm mb-0">
                            ...
                            <?php else: ?>
                                <li class="page-item">
                                    <a class="page-link border-0 rounded-pill" href="<?php echo e($incomes->url(1)); ?>" aria-label="First">
                                        <i class="fas fa-angle-double-right"></i>
                                    </a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php else: ?>
                                <li class="page-item">
                                    <a class="page-link border-0 rounded-pill" href="<?php echo e($incomes->previousPageUrl()); ?>" aria-label="Previous">
                                        <i class="fas fa-angle-right"></i>
                                    </a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if($incomes->hasMorePages()): ?>
                                <li class="page-item">
                                    <a class="page-link border-0 rounded-pill" href="<?php echo e($incomes->nextPageUrl()); ?>" aria-label="Next">
                            ...
                            <?php if($incomes->hasMorePages()): ?>
                                <li class="page-item">
                                    <a class="page-link border-0 rounded-pill" href="<?php echo e($incomes->url($incomes->lastPage())); ?>" aria-label="Last">
                    ...
                    <table class="table">
                        <tbody>
                            <?php $__currentLoopData = $incomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td style="width: 80%">
                                        <p><strong><?php echo e($income->seller); ?></strong></p>
                                        ...
                                        <i class="fa fa-user"></i> <small>اضيفت بواسطة :</small> <strong><?php echo e($income->user->name ?? ""); ?></strong>
                                    </td>
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton303">
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('incomes.show', $income->id)); ?>">
                                                            <i class="fa fa-eye me-2 text-primary"></i>عرض
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('incomes.edit', $income->id)); ?>">
                                                            <i class="fa fa-edit me-2 text-success"></i>تعديل
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('incomes.print', ['id' => $income->id, 'type' => 'thermal'])); ?>">
                                                            <i class="fa fa-print me-2 text-info"></i>طباعة سند قبض حراري
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('incomes.print', ['id' => $income->id, 'type' => 'normal'])); ?>">
