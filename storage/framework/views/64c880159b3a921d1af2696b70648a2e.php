                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <fieldset class="form-group position-relative  mx-1 my-0 w-50">
                                                <select name="" class="form-control select2" id="">
                                                    <option value="all">كل الفروع</option>
                                                    <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($branch->id); ?>"><?php echo e($branch->name); ?>
...
<?php /**PATH C:\xampp\htdocs\fawtramsmart\fawtra\resources\views/accounts/accounts_chart/tree.blade.php ENDPATH**/ ?>