                                        ...
                                        <td>
                                            <p class="mb-0">
                                                <i class="fas fa-map-marker-alt text-primary me-2"
                                                    ...
                                                    onclick="openMap(<?php echo e($client->locations->latitude ?? 0); ?>, <?php echo e($client->locations->longitude ?? 0); ?>)"></i>
            ...
            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($client->locations && $client->locations->latitude && $client->locations->longitude): ?>
                    const marker<?php echo e($client->id); ?> = new google.maps.Marker({
                        ...
                        label: "<?php echo e($client->code); ?>"
                    });

                    const contentString<?php echo e($client->id); ?> = `
                    <div style="color: #333; font-family: Arial, sans-serif;">
                        <h4 style="margin: 0; font-size: 16px; color: #007BFF;"><?php echo e($client->trade_name); ?></h4>
                        <p style="margin: 5px 0; font-size: 14px;">
                            <strong>الكود:</strong> <?php echo e($client->code); ?>

                        </p>
                        <p style="margin: 5px 0; font-size: 14px;">
                            <strong>الاسم:</strong> <?php echo e($client->first_name); ?> <?php echo e($client->last_name); ?>

                        </p>
                        <p style="margin: 5px 0; font-size: 14px;">
                            <strong>الهاتف:</strong> <?php echo e($client->phone); ?>

                        </p>
                        <p style="margin: 5px 0; font-size: 14px;">
                            <strong>العنوان:</strong> <?php echo e($client->city); ?>, <?php echo e($client->region); ?>

                        </p>
                        <p style="margin: 5px 0; font-size: 14px;">
                            <strong>الرمز البريدي:</strong> <?php echo e($client->postal_code); ?>

                        </p>
 <p style="margin: 5px 0; font-size: 14px;">
                            <strong>الرصيد:</strong> <?php echo e($client->Balance); ?>

                        </p>
                        <a href="<?php echo e(route('clients.show', $client->id)); ?>" target="_blank" style="color: #007BFF; text-decoration: none; font-size: 14px;">
                            عرض التفاصيل
                        </a>
                    </div>
                `;
