...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-body">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div>
                        <a href="<?php echo e(route('incomes.index')); ?>" class="btn btn-outline-danger">
        ...
        <div class="card">
            <div class="card-body">
                <form id="incomes_form" action="<?php echo e(route('incomes.update', $income->id)); ?>" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control form-control-lg py-3" id="amount"
                                placeholder="<?php echo e($currencySymbol); ?> 0.00" name="amount" value="<?php echo e(old('amount', $income->amount)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control form-control-lg py-3" id="total_amount"
                                placeholder="<?php echo e($currencySymbol); ?> 0.00" name="total_amount" readonly value="<?php echo e(old('total_amount', $income->total_amount)); ?>">
                        </div>

                        <div class="form-group col-md-3">
                            <label for="description">الوصف</label>
                            <textarea class="form-control" id="description" rows="3" name="description"><?php echo e(old('description', $income->description)); ?></textarea>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <?php if($income->attachments): ?>
                                <div class="mt-2">
                                    <?php $__currentLoopData = json_decode($income->attachments); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div><?php echo e(basename($attachment)); ?></div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="code-number" name="code"
                                value="<?php echo e(old('code', $income->code)); ?>" readonly>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="date">التاريخ</label>
                            <input type="date" class="form-control" id="date" name="date" value="<?php echo e(old('date', $income->date)); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <select id="category" class="form-control" name="incomes_category_id">
                                ...
                                <?php $__currentLoopData = $incomes_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incomes_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($incomes_category->id); ?>"
                                        <?php echo e(old('incomes_category_id', $income->incomes_category_id) == $incomes_category->id ? 'selected' : ''); ?>>
                                        <?php echo e($incomes_category->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <select id="seller" class="form-control" name="vendor_id">
                                ...
                                <option value="1" <?php echo e(old('vendor_id', $income->vendor_id) == 1 ? 'selected' : ''); ?>>بائع 1</option>
                                <option value="2" <?php echo e(old('vendor_id', $income->vendor_id) == 2 ? 'selected' : ''); ?>>بائع 2</option>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                                ...
                                <select class="form-control select2" name="account_id" id="account_id" required>
                                    ...
                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($account->id); ?>"
                                            <?php echo e(old('account_id', $income->account_id) == $account->id ? 'selected' : ''); ?>>
                    ...
                    <!-- حقول الضرائب -->
                    <div id="tax-fields" class="tax-fields" style="<?php echo e(old('tax1') || $income->tax1 ? 'display: block;' : 'display: none;'); ?>">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="tax2" class="form-control" name="tax2">
                                    ...
                                    <?php $__currentLoopData = $taxs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tax->tax); ?>"
                                            <?php echo e(old('tax2', $income->tax2) == $tax->tax ? 'selected' : ''); ?>>
                                            <?php echo e($tax->name ?? ''); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <input type="text" class="form-control mt-2" placeholder="المبلغ" name="tax2_amount"
                                    value="<?php echo e(old('tax2_amount', $income->tax2_amount)); ?>">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="checkbox" id="checkbox" name="is_recurring" value="1"
                                            <?php echo e(old('is_recurring', $income->is_recurring) ? 'checked' : ''); ?>>
                                    </div>
                                </div>
                                <!-- حقل التكرار و تاريخ الإنتهاء يظهر عند تحديد الـ checkbox -->
                                <div class="row" id="duplicate-options-container" style="<?php echo e(old('is_recurring', $income->is_recurring) ? 'display: block;' : 'display: none;'); ?>">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select id="duplicate-options" class="form-control" name="recurring_interval">
                                            ...
                                            <option value="weekly" <?php echo e(old('recurring_interval', $income->recurring_interval) == 'weekly' ? 'selected' : ''); ?>>إسبوعي</option>
                                            <option value="bi-weekly" <?php echo e(old('recurring_interval', $income->recurring_interval) == 'bi-weekly' ? 'selected' : ''); ?>>كل أسبوعين</option>
                                            <option value="monthly" <?php echo e(old('recurring_interval', $income->recurring_interval) == 'monthly' ? 'selected' : ''); ?>>شهري</option>
                                            <option value="yearly" <?php echo e(old('recurring_interval', $income->recurring_interval) == 'yearly' ? 'selected' : ''); ?>>سنوي</option>
                                            <option value="daily" <?php echo e(old('recurring_interval', $income->recurring_interval) == 'daily' ? 'selected' : ''); ?>>يومي</option>
                                        </select>
                                    </div>
                                </div>

                                <!-- حقل تاريخ الإنتهاء -->
                                <div class="row" id="end-date-container" style="<?php echo e(old('is_recurring', $income->is_recurring) ? 'display: block;' : 'display: none;'); ?>">
                                    <div class="form-group col-md-4">
                                        <label for="end-date">تاريخ الإنتهاء</label>
                                        <input type="date" class="form-control" id="end-date" name="end_date"
                                            value="<?php echo e(old('end_date', $income->end_date)); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtramsmart\fawtra\resources\views/finance/incomes/edit.blade.php ENDPATH**/ ?>