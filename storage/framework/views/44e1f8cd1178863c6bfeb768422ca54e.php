    ...
    <div class="content-body">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form id="products_form" class="form form-vertical" action="<?php echo e(route('treasury.store_account_bank')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email-id-vertical" class="form-control"name="name" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email-id-vertical" class="form-control"name="bank_name" value="<?php echo e(old('bank_name')); ?>">
                                        <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email-id-vertical" class="form-control"name="account_number" value="<?php echo e(old('account_number')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="basicSelect" name="currency">
                                            <option value="0" <?php echo e(old('currency') == 0 ? 'selected' : ''); ?>>ريال</option>
                                            <option value="1" <?php echo e(old('currency') == 1 ? 'selected' : ''); ?>>جنية</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" id="basicTextarea" rows="2"><?php echo e(old('description')); ?></textarea>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="deposit_permissions" name="deposit_permissions">
                                                    ...
                                                    <option value="1" <?php echo e(old('deposit_permissions') == 1 ? 'selected' : ''); ?>>موظف محدد</option>
                                                    <option value="2" <?php echo e(old('deposit_permissions') == 2 ? 'selected' : ''); ?>>دور وظيفي محدد</option>
                                                    <option value="3" <?php echo e(old('deposit_permissions') == 3 ? 'selected' : ''); ?>>فرع محدد</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="withdraw_permissions" name="withdraw_permissions">
                                                    ...
                                                    <option value="1" <?php echo e(old('withdraw_permissions') == 1 ? 'selected' : ''); ?>>موظف محدد</option>
                                                    <option value="2" <?php echo e(old('withdraw_permissions') == 2 ? 'selected' : ''); ?>>دور وظيفي محدد</option>
                                                    <option value="3" <?php echo e(old('withdraw_permissions') == 3 ? 'selected' : ''); ?>>فرع محدد</option>
                                                </select>
                                            </div>
                                        </div>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fawtramsmart\fawtra\resources\views/finance/treasury/create_account_bank.blade.php ENDPATH**/ ?>